...
namespace GenTRAC.Tests.DAL
{
    ...
    public static class DtoAssertHelpers
    {
        ...
        public static void AssertDtos(ProposalDto expectedResult, ProposalDto actualResult, bool legacy = false)
        {
            ...
            Assert.AreEqual(UNTESTABLE_PROPERTIES + 82, numProperties, "Untested properties exist in the DTO.");
			...
			//75
			Assert.AreEqual(expectedResult.CcopdNoReason, actualResult.CcopdNoReason);
			Assert.AreEqual(expectedResult.CcopdNoOtherReason, actualResult.CcopdNoOtherReason);
			Assert.AreEqual(expectedResult.IsSupportOfUndefinitized, actualResult.IsSupportOfUndefinitized);
			Assert.AreEqual(expectedResult.IsRomNte, actualResult.IsRomNte);
			Assert.AreEqual(expectedResult.SubjectToAlternativePricingMethodology, actualResult.SubjectToAlternativePricingMethodology);
			// 80
			Assert.AreEqual(expectedResult.AlternativePricingMethodology, actualResult.AlternativePricingMethodology);
			Assert.AreEqual(expectedResult.AlternativePricingMethodologyOtherText, actualResult.AlternativePricingMethodologyOtherText);
