...
namespace IES.Tests
{
    ...
    public class TestData
    {
        ...
        private static IRevisionMediator revisionMediator = new RevisionMediator(new RevisionLoader(), new NonCacheDataLoader());

        /// <summary>
        /// RateConfig Loader
        /// </summary>
        private static RateConfigLoader rateConfigLoader = new RateConfigLoader();

        /// <summary>
        /// Revision Loader
        /// </summary>
        private static RevisionLoader revisionLoader = new RevisionLoader();

        /// <summary>
        /// Burden Pool loader
        /// </summary>
        private static BurdenPoolLoader burdenPoolLoader = new BurdenPoolLoader();

        /// <summary>
        /// Section Loader
        /// </summary>
        private static SectionLoader sectionLoader = new SectionLoader();

        /// <summary>
        /// Cobra Detail loader
        /// </summary>
        private static CobraDetailLoader cobraDetailLoader = new CobraDetailLoader();

        /// <summary>
        /// Cobra Years loader
        /// </summary>
        private static CobraYearsLoader cobraYearsLoader = new CobraYearsLoader();

        /// <summary>
        /// Rate Code Year loader
        /// </summary>
        private static RateCodeYearLoader rateCodeYearLoader = new RateCodeYearLoader();

        /// <summary>
        /// ProPricer Rate Code Xref loader
        /// </summary>
        private static ProPricerRateCodeXrefLoader proPricerXrefLoader = new ProPricerRateCodeXrefLoader();

        /// <summary>
        /// Rate Detail loader
        /// </summary>
        private static RateDetailLoader rateDetailLoader = new RateDetailLoader(rateCodeYearLoader, proPricerXrefLoader);

        /// <summary>
        /// The file attachment loader
        /// </summary>
        private static FileAttachmentLoader fileAttachmentLoader = new FileAttachmentLoader();

        /// <summary>
        /// The banner loader
        /// </summary>
        private static IBannerLoader bannerLoader = new BannerLoader();

        /// <summary>
        /// The rate code replication loader
        /// </summary>
        private static IRateCodeReplicationLoader rateCodeReplicationLoader = new RateCodeReplicationLoader();
        ...
        /// </summary>
        private List<RevisionModelView> revisionCleanupList = new List<RevisionModelView>();
        ...
        /// Generic revision
        /// </summary>
        private RevisionModelView genericRevision = new RevisionModelView()
        {
            Id = 888888,
            Revision = "888888",
        ...
        public RevisionModelView GetRevision(bool createNew = false, RevisionModelView revisionModelView = null)
        {
            ...
            if (createNew)
            {
                using (TransactionScope scope = new TransactionScope())
                {
                    ...
                    {
                        RevisionModelView newRevision = new RevisionModelView()
                        {
                            Id = -1,
        ...
        public RevisionModelView ModifyRevisionData1(RevisionModelView revision)
        {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = IsolationLevel.Snapshot }))
            {
                ...
                // Add Rate data
                RateDetailModelView rateDetail1 = new RateDetailModelView()
                {
                    Id = -1,
                    RevisionId = revision.Id,
                    IsDeleted = false,
                ...
                RateDetailModelView rateDetail2 = new RateDetailModelView()
                {
                    Id = -2,
                    RevisionId = revision.Id,
                    RateCode = "MockRate2",
                ...
                RateDetailModelView rateDetail3 = new RateDetailModelView()
                {
                    Id = -3,
                    RevisionId = revision.Id,
                    IsDeleted = false,
                ...
                RateDetailModelView rateDetail4 = new RateDetailModelView()
                {
                    Id = -4,
                    RevisionId = revision.Id,
                    IsDeleted = false,
        ...
        public void ModifyRevisionData2(RevisionModelView revision)
        {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = IsolationLevel.Snapshot }))
            {
                ...
                // Add a new rate code
                RateDetailModelView rateDetail5 = new RateDetailModelView()
                {
                    Id = -5,
                    RevisionId = revision.Id,
                    RateCode = "MockRate5",
        ...
        public void AddStandardSectionData(RevisionModelView revision)
        {
            ...
            // Add some sections
            SectionModelView section0 = new SectionModelView()
            {
                Id = -1,
                RevisionUniqueSectionId = -1,
                Title = "Introduction",
            ...
            SectionModelView section1 = new SectionModelView()
            {
                Id = -1,
                RevisionUniqueSectionId = -1,
        ...
        public RevisionModelView AddBaselineSectionsAndRatesData(RevisionModelView revision)
        {
            ...
            SectionModelView section11 = new SectionModelView()
            {
                Id = -1,
                DisplayOrder = 1,
                ParentId = null,
            ...
            SectionModelView section111 = new SectionModelView()
            {
                Id = -1,
                DisplayOrder = 1,
                ParentId = null,
            ...
            SectionModelView section112 = new SectionModelView()
            {
                Id = -1,
                DisplayOrder = 2,
                ParentId = null,
            ...
            SectionModelView section2 = new SectionModelView()
            {
                Id = -1,
                DisplayOrder = 2,
                ParentId = null,
            ...
            SectionModelView section21 = new SectionModelView()
            {
                Id = -1,
                DisplayOrder = 1,
                ParentId = null,
            ...
            SectionModelView section22 = new SectionModelView()
            {
                Id = -1,
                DisplayOrder = 2,
                ParentId = null,
            ...
            SectionLoader sut = new SectionLoader();
            ...
            FileAttachmentRowModelView attachment1 = new FileAttachmentRowModelView
            {
                Id = -1,
            ...
            FileAttachmentRowModelView attachment2 = new FileAttachmentRowModelView
            {
                Id = -2,
