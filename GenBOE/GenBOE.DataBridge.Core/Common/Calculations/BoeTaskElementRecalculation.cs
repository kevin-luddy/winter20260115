...
//		{
//			_VarSelectBOEtoSumCalc = inVarSelectBOEtoSumCalc;
//			_Factory = factory;
//		}
...
//			try
//			{
//				calculatedResult = Parser.Calculate(boeTaskElement.MOQHoursEquation, boeTaskElement.OrdinaryVariables, workspaceVars, _VarSelectBOEtoSumCalc, data, fullWorkspace);
//			}
...
//			{
//				Collection<BoeTaskElementDTO> tasks = RecalculateLaborWithVariable(x, variableType, fullWorkspace, incomingBoeTaskElements, incomingWorkspaceVariables);
...
//				BoeTaskElementDTO updatedBoeTask = RecalculateLaborWithTaskElement(dto, variableType, fullWorkspace, incomingBoeTaskElements);
...
//			if (parentWBS != null)
//			{
//				List<BoeTaskElementDTO> returnWBS = RecalculateLaborWithWBS(parentWBS, variableType, fullWorkspace, incomingBoeTaskElements, incomingWorkspaceVariables);
//				// add the task elements only if they do not exist in the current list
...
//			{
//				taskVariable.OrdinaryVariableValue = _VarSelectBOEtoSumCalc.GetTaskVarLabelTotal(taskVariable, data);
//				taskVariable.Updateable = UpdateType.Upsert;
//			}

//			string moqTotal = Parser.Calculate(boeTaskElement.MOQHoursEquation, boeTaskElement.OrdinaryVariables, workspaceVarsForTaskElement, _VarSelectBOEtoSumCalc, data, fullWorkspace);
...
//			RecalculateLaborWithBoe(boeForTaskElement, variableType, fullWorkspace, incomingBoeTaskElements);
...
//			foreach (int x in VarIDs)
//			{
//				Collection<BoeTaskElementDTO> returnTaskVar = RecalculateLaborWithVariable(x, variableType, fullWorkspace, incomingBoeTaskElements, incomingWorkspaceVariables);
...
//				List<BoeTaskElementDTO> returnClin = this.RecalculateLaborWithClin(_Factory.CreateFullClin(clinAssociatedWithBoe), variableType, fullWorkspace, incomingBoeTaskElements, incomingWorkspaceVariables);
...
//				List<BoeTaskElementDTO> returnWBS = RecalculateLaborWithWBS(wbsAssociatedWithBoe, variableType, fullWorkspace, incomingBoeTaskElements, incomingWorkspaceVariables);
...
//		/// <exception cref="ArgumentNullException">inBoeTaskElement</exception>
