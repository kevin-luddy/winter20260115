...
//							if (StartAndEndDatesAreValid(workspace, tmResourceRates, resource, validationErrors))
//							{
...
//			ValidateBOEFormsTMResources(validationErrors, resourceIdsWithValidTMRates, fullWorkspace,
//				iboeDtos, pboeDtos, tmResourceRateLoader, resourceLoader);

//			result.Data = CalculatePBOETotals(pboeDtos, fullWorkspace, resourceLoader, resourceIdsWithValidTMRates);
//		}
...
//			result.Data = CalculateIBOETotals(iboeDtos, fullWorkspace, resourceLoader, resourceIdsWithValidTMRates);
//		}
