...
namespace IES.Common.Core.Enums
{
	...
	public enum ProposalChecklistType
	{
		...
		/// </summary>
		[Core.Attributes.IsActive(false)]
	...
	public enum ProposalLocation
	{
		...
		/// Chantilly, VA
		/// </summary>
		[Description("Chantilly, VA"), Core.Attributes.IsActive(false)]
		ChantillyVA = 1,

		/// <summary>
		/// Colorado Springs, CO
		/// </summary>
		[Description("Colorado Springs, CO"), Core.Attributes.IsActive(false)]
		ColoradoSpringsCO = 2,

		/// <summary>
		/// Hanover, MD
		/// </summary>
		[Description("Hanover, MD"), Core.Attributes.IsActive(false)]
		HanoverMD = 3,

		/// <summary>
		/// Herndon, VA
		/// </summary>
		[Description("Herndon, VA"), Core.Attributes.IsActive(false)]
		HerndonVA = 4,

		/// <summary>
		/// Littleton, CO
		/// </summary>
		[Description("Littleton, CO"), Core.Attributes.IsActive(false)]
		LittletonCO = 5,

		/// <summary>
		/// Rockville, MD
		/// </summary>
		[Description("Rockville, MD"), Core.Attributes.IsActive(false)]
		RockvilleMD = 6,
		...
		/// Virtual
		/// </summary>
		[Description("Virtual"), Core.Attributes.IsActive(false)]
		Virtual = 8,
