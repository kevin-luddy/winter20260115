...
namespace IES.Common.Core.Models
{
	...
	public class DateRange : IEquatable<DateRange>
	{
		...
		public DateTime? StartDate
		{
			...
			set
			{
				AssertEndDateFollowsStartDate(value, endDate);
				startDate = value;
			}
		}
		public DateTime? EndDate
		{
			...
			set
			{
				AssertEndDateFollowsStartDate(startDate, value);
				endDate = value;
			}
		}
		private void AssertEndDateFollowsStartDate(DateTime? inStartDate,
			DateTime? inEndDate)
		{
