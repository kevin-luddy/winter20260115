		...
		where TDtoType : IUpdateableDTO
	{
		...
		protected void ValidateTransactionScope()
		{
			if (Transaction.Current == null)
			{
				...
				Log.LogWarning("A transaction was not supplied with the save, please create a bug report." + Environment.NewLine + Environment.StackTrace);
			}
		}
