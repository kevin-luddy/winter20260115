...
namespace IES.Common.Core.Loaders
{
	...
	public class NonCacheDataLoader : ICacheDataLoader
	{
		...
		{
			return GetData(inLoaderMethod, inLoadMethodParams, inKeyForCache, true);
		}
		...
		{
			return GetData(inLoaderMethod, inLoadMethodParams, inKeyForCache, inUseClone, -1);
		}
		...
		{
			return GetDataNoCacheResult(inLoaderMethod, inLoadMethodParams, inKeyForCache, true);
		}
		...
		{
			return _GetData(inLoaderMethod, inCacheKeyToIDDictionary, inExtraParam, inUseClone);
		}
