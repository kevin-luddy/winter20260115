...
namespace IES.Common.Core.OfficeUtilities
{
	...
	public static class WordUtilities
	{
		...
		/// </summary>
		public const string OPENING_UCOT_LABEL_TEXT = "** The hours generated by the Uncompensated OT HEF are included in the Resource IDs appended with “-UCOT” and are in addition to the hours calculated within the respective actuals based MOQ Equation(s). See ";
		...
		/// <summary>
		/// Last part of the Resource Summary UCOT Label Text
		/// </summary>
		public const string CLOSING_UCOT_LABEL_TEXT = " section of the Cost Volume for additional details.";
		...
		public static void AddUcotLabelToContainer (StructuredDocumentTag containerElement)
		{
			if (containerElement != null)
			{
				...
				paragraph.AppendChild(closingRun);
			}
		}
