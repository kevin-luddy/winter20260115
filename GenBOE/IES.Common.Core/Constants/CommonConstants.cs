...
namespace IES.Common.Core.Constants
{
	...
	static public class CommonConstants
	{
		...
		readonly static public string BOE_MOQ_TYPES_HELP_TEXT_MST = @"<b>Actual Program or Task Cost Data (Historical)</b> - Extrapolation of actual hours/costs based on prior performance of a similar activity.<br /><br /><b>Comparative Analysis</b> - Estimate based on historical performance from a similar effort with adjustments for programmatic or technical.<br /><br /><b>Cost Estimating Relationships (CERs)</b> - Equations developed based on historical or statistically correlated relationship and valid explanation for the correlation (causal relationship).<br /><br /><b>Parametric Estimates</b> - Use of calibrated, internally developed, or commercially available cost models.<br /><br /><b>Analogous Relationships (ARs)</b> - Use of calibrated, internally developed, or commercially available analogous relationship models.<br /><br /><b>Statement of Work (SOW)</b> - Uses resource-based estimates directed in the Statement of Work (SOW).<br /><br /><b>Level of Effort (LOE)</b> - Uses resource-based estimates that are often based on a predetermined level of support for a given period of time.<br /><br /><b>Subject Matter Expert (SME) Judgement</b> - Based on subject matter expert (SME) experience with similar efforts. This is the least preferable methodology to use.<br /><br /><b>Non-Labor</b> - Used for estimating non-labor resource, e.g. ODC costs";
		...
		/// <summary>
		/// Validation CommonConstants for PickList across PTM/BOE
		/// </summary>
		...
		/// <summary>
		/// CommonConstants used by Sikorsky Custom Fields
		/// </summary>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1034:NestedTypesShouldNotBeVisible")]
		...
		/// <summary>
		/// CommonConstants used by ProPricer Custom Fields
		/// </summary>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1034:NestedTypesShouldNotBeVisible")]
