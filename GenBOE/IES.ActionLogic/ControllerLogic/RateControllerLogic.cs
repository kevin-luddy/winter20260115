...
namespace IES.ActionLogic.ControllerLogic
{
	...
	public class RateControllerLogic : RdmControllerLogic, IRateControllerLogic
	{
		...
		/// <summary>
		/// Helper method to determine if any of the extended Resource Classes (i.e. 1-7) are populated without a corresponding Rate Description.
		/// </summary>
		/// <param name="rateDetailModelView">The rate detail mv</param>
		/// <returns>True if any of the extended Resource Classes (i.e. 1-7) are populated without a corresponding Rate Description; False otherwise.</returns>
