...
<div id="MOQEquationField" class="bootstrap" data-ng-controller="MoqEquationController" data-ng-init="init()">
    ...
    <div data-ng-if="model.UsingTemplateBOE" class="form-row moqContainerClass">
        ...
        <div class="form-element">
			...
			<button data-ng-if="!ActualReadOnly() && model.SapConnectionEnabled && model.SAPEnabled" ng-disabled="calculateAllDisabled" data-ng-click="calculateAllMoqActuals()" class="moqTypesButton ies-action" type="button">Calculate All Actuals</button>
        </div>
    </div>
