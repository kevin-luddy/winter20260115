                        ...
                        <table name="currentSkillMix" class="grid editable" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr ng-repeat="row in skillMixRationale.data.SkillMixRows">
                                    <td data-ng-if="!$scope.isSkillMixManual()">{{row.ResourceOld}}</td>
                                    <td data-ng-if="$scope.isSkillMixManual()"><input type="text" data-ng-model="row.ResourceOld" style="width: 100%; height: 14px;" maxlength="20" /></td>
                                    <td>
                                    ...
                                    <td data-ng-if="!$scope.isSkillMixManual()" style="text-align: right">{{row.HistoricalHours | number:2}}</td>
                                    <td data-ng-if="$scope.isSkillMixManual()" style="text-align: right"><input type="number" data-ng-model="row.HistoricalHours" step="any" style="width: 100%; height: 14px;" /></td>
