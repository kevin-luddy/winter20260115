...
<div id="TaskElementsComposite" class="task-elements-composite composite container-fluid" data-ng-app="genboe" data-ng-controller="ManageTaskController" data-ng-init="init('<%= ViewData["TASKID"] != null ? ViewData["TASKID"] : "-1" %>')" data-ng-cloak="">
                ...
                <div data-ng-hide="isLoading">
                    ...
                    <div class="import-buttons">
                        ...
                        <div>
                            ...
                            <select data-ng-change="updateDropdowns()" data-ng-disabled="isLoading || isExporting" data-ng-model="showDropdowns"><option data-ng-value="false">No</option><option data-ng-value="true">Yes</option></select>
                                ...
                                <table class="labor-types-grid addable grid editable" id="LaborTypes" name="laborTypes">
                                    ...
                                    <tbody>       
                                        <tr data-ng-repeat="item in tableData | filter: { Deleted: false } track by item.BOELaborTypeID" pkid="{{item.BOELaborTypeID}}" data-ng-init="outerIndex = $index">
                                            <td data-ng-repeat="customField in LaborCustomFields" class="custom-field" data-ng-init="innerIndex = $index">
                    ...
                    <div id="LaborSpreadGridBlock" data-ng-cloak>
                        ...
                        <div data-ng-if="(tableData | filter: { Deleted: false, NewLaborType: false }).length > 0" class="labor-spread-scroll">
                            <table class="data" name="LaborSpreadData">
                                ...
                                <tbody>
                                    <tr data-ng-repeat="item in tableData | filter: { Deleted: false, NewLaborType: false } track by item.BOELaborTypeID">
                                        <td data-ng-repeat="dt in model.SpreadDatesFull" date="{{dt}}" data-ng-class="{inputError: item.SpreadDataInvalid[$index]}">
                                            {{ isInRange = isMonthInRange(dt.toDate(), item.StartDate.toDate(), item.EndDate.toDate()); "" }}
    ...
    <div class="buttons" data-ng-hide="isLoading">  
        ...
        <button data-ng-if="taskElementId" data-ng-hide="isSaving" data-ng-click="saveAndContinue()" id="Save-BOEUpdatesAndContinue" class="ies-action stateful_button" name="save-button" type="button">Save & Continue</button>
        <button id="Save-BOEUpdatesAndClose" data-ng-hide="isSaving" data-ng-click="saveAndClose()" class="ies-action stateful_button" name="save-button" type="button">Save & Close</button>
        <button id="Save-BOEUpdatesAndAddAnother" data-ng-hide="isSaving" data-ng-click="saveAndAddAnother()" class="ies-action stateful_button" name="save-button" type="button">Save & Add Another</button>
    ...
    <div id="importLaborTypesDialog" class="import-labor-types dialog form" style="display:none;">
        <div id="ImportInstructions">
            ...
            <div class="step two display-none" path="New">
                ...
                <div>
                    Start by downloading the Resource Type template file. This file has the correct column headings genBOE needs to import the Resource Types.<br /><br />
