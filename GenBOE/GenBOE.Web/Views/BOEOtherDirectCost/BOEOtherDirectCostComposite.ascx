...
<script type="text/javascript">
	...
	ODCElementsComposite.BannerTextWithOCI = '<%= SiteMasterUtilities.GetBannerText() %>';
	ODCElementsComposite.BannerTextWithoutOCI = '<%= SiteMasterUtilities.GetBannerText(true) %>';
