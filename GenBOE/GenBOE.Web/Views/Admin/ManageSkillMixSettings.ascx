...
<div id="ManageSkillMixSettings" class="manage-skill-mix-settings section">
    ...
    <form name="skillMixSettingsForm" id="skillMixSettingsForm">
        <div data-ng-cloak>
            ...
            <div class="form-row">
                <div ui-grid="gridOptions" ui-grid-edit ui-grid-cellNav ui-grid-exporter class="skill-mix-setting-grid-ui" />
            </div>
            <div class="form-row css3pie-position-fix last-form-row">
                <div class="inline css3pie-position-fix">
                    <button data-ng-click="saveSkillMixSettings()" data-ng-disabled="isDataLoading || !PageIsDirty" type="button" class="ies-action">Save</button>
