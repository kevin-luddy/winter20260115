    ...
    <div id="BOEDetailTabs">
        <div class="tabs">
            ...
            <div class="tabs-center">
                <ul>
                    <li class="active"><div class="tab-left"></div><a href="#LMLabor" tab="LMLabor">LM / IWTA / Sub Labor</a><div class="tab-right"></div></li>
                    <% if ((bool)ViewData["displayTravelTab"] != false) { %>
                    <li><div class="tab-left"></div><a href="#Travel" tab="Travel">Travel</a><div class="tab-right"></div></li>
                    <% } %>
                    <li><div class="tab-left"></div><a href="#Material" tab="Material">Material</a><div class="tab-right"></div></li>
                    <% if ((bool)ViewData["displayODCTab"] != false) { %>
                    <li><div class="tab-left"></div><a href="#ODC" tab="ODC">ODC</a><div class="tab-right"></div></li>
                    <% } %>
                    <li><div class="tab-left"></div><a href="#Comments" tab="Comments">Comments & Approvals</a><div class="tab-right"></div></li>
                    <li><div class="tab-left"></div><a href="#History" tab="History">History</a><div class="tab-right"></div></li>
                </ul>
            </div>
