        ...
        <div class="form-row">
            <div class="form-label">
                ...
                <div id="Options-HelpDialog" class="help-dialog" style="width: 300px;">
                    <div class="help-dialog-close"></div>
                    <div class="help-dialog-text">Users will be able to select one of these options for the field.<br /><br />Options currently in use by a BOE cannot be deleted. To delete the option, Authors must select a different option in their BOEs.</div>
                </div>
            </div>
            <div class="form-element">
                <div class="buttons">
...
<div id="ImportDialog" class="import-elements-of-cost dialog form" style="display: none;">
    ...
    <div class="form-element">
        ...
        <ul style="padding: 0px 0px 0px 15px; margin: 10px 0px 0px 0px;">
            <li>File must contain the same headers as <a id="ExportTemplate-CustomResource"> 
...
<div id="ImportResultsDialog" class="import-results-dialog" style="display: none;">
    The Import of Resource options was successful.<br /><br />
    <div class="container">
...
<div class="manage-boe-resources-edit" id="OptionDialog" style="display: none;">
    ...
    <ul class="validation-box"></ul>
        ...
        Resource option is currently in use by at least <br /> one BOE. Any changes to an in use resource <br /> option will apply to all BOEs using the resource. <br /> All BOE authors and approvers of modified BOEs <br />in the Awaiting Approval & Approved state will be <br />notified of changes via email.
        </div>
...
<div id="DefaultResourceList" class="default-resouce-dialog" style="display: none;">
    ...
    <div id="DefaultResourceList-Waiting">
        <br />
        Retrieving <%: ViewData["SYSTEM_LIST_NAME"]%> Default Options    </div>
