...
<div id="WorkspaceIdentification" class="workspace-identification module ">
    ...
    <div class="module-content-data">
        ...
        <div class="form-row">
            <div class="form-label">
                Contract Type *<span helptext="Select all applicable contract types for this workspace. ONLY those contract types selected here will be available for selection and assignment by CLIN on the Manage CLINs -> Edit CLIN Element screen."></span></div>
            <div class="form-element">
        ...
        <div class="form-row">
            ...
            <div class="form-element">
                <input type="text" disabled="disabled" value="<%: Model.ContractStartDate %>" class="small-date" name="StartDate" id="StartDate" /></div>
            <div class="form-label contract-end-date">Contract End Date *</div>
            <div class="form-element">
                <input type="text" disabled="disabled" value="<%: Model.ContractEndDate %>" class="small-date" name="EndDate" id="EndDate" />&nbsp;&nbsp;<a id="AdjustDatesLink" style="float: right;">Adjust Dates</a></div>
        </div>
        <div class="form-row">
            <div class="form-label">
        ...
        <div class="form-row" >
            <div class="form-label">
                <span helptext="'Yes' if this proposal was created with the intent of using T&M Subcontractor/IWTA Labor Rates to develop the PBOEs/IBOEs; 'No' otherwise.">Is using T&M Subcontractor/IWTA<br />Labor Rates</span>
            </div>
