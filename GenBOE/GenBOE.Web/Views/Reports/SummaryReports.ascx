...
<script type="text/javascript">
    ...
    var SummaryReportsWidget = new GridWidget("SummaryReports");

    $(function () {
        createModule($('.summary-reports.module'));

        $('#SummaryReports a[name="SummaryReports-ViewButton"]').click(function () {
            var data = {};
        ...
        $('#SummaryReports img.wordIcon').click(function () {
            $('#SummaryReports input.wordIcon').attr('checked', true);
        });

        $('#SummaryReports img.excelIcon').click(function () {
            $('#SummaryReports input.excelIcon').attr('checked', true);
        });

        $('#SummaryReports i.pdfIcon').click(function () {
            $('#SummaryReports input.pdfIcon').attr('checked', true);
        });

        refreshModule($('.summary-reports.module'));
        CollapsibleModule($('.summary-reports.module'));
    });

</script>

<div id="SummaryReports" class="summary-reports module expanded inner-collapsible">
    <div class="module-header-data">Summary Reports</div>
        ...
        <table class="grid readonly">
            ...
            <tbody>
                ...
                <tr pkid="<%: item.ReportID %>" reportName="<%: item.ReportName %>" ssrsUrl="<%: item.ReportUrl %>">
                    ...
                    <td><span><a name="SummaryReports-ViewButton">View</a></span></td>
                </tr>
                <% } %>
            </tbody>
        </table>
