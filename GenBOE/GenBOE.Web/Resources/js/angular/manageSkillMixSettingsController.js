...
//    app.controller('manageSkillMixSettingsController', ['$scope', '$rootScope', 'ManageSkillMixSettingsModelView', '$http', 'uiGridConstants', function ($scope, $rootScope, ManageSkillMixSettingsModelView, $http, uiGridConstants) {
//        $rootScope.errors = [];
...
//            $http({
//                method: 'POST',
//                url: GenSession.CreateSystemAdminPostURL(ManageSkillMixSettingsModelView.controller, ManageSkillMixSettingsModelView.getSkillMixSettingsAction),
//                data: {}
