...
function ActiveDirectorySearchDialog(callbackFunction, callbackArgs) {
        ...
        '<table class="SearchCriteria">' +
            ...
            '<tr>' +
                    '<td>' +
                        ...
                        '<input id="selectedWorkPhone" name="selectedWorkPhone" type="hidden" />' +
                    '</td>' +
    ...
    $("#ActiveDirectorySearchDialog").dialog({
        ...
        if (callbackFunction != undefined) {
            ...
            var selectedWorkPhone = $('#selectedWorkPhone').val();

            var results = { "AccountName": selectedAccountName, "Email": selectedEmail, "DisplayName": selectedDisplayName, "WorkPhone": selectedWorkPhone };
...
function ProcessActiveDirectorySelection(results) {
    ...
    $('#selectedWorkPhone').val(results.WorkPhone);
...
function SubmitActiveDirectorySearch(form) {
    var irisurl = "/" + "default/Home/Search?" + $(form).serialize();
