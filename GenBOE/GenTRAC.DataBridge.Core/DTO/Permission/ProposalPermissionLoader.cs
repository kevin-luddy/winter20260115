...
namespace GenTRAC.DataBridge.DTO
{
	...
	public class ProposalPermissionLoader : DataLoader<ProposalPermissionDto>, IProposalPermissionLoader
    {
        ...
        public override ICollection<ProposalPermissionDto> GetByIds(ICollection<int> ids)
        {
            ...
            using (IES.Core.StopwatchTimer sw = new IES.Core.StopwatchTimer("ProposalPermissionLoader.GetById", Log))
            {
        ...
        public ICollection<ProposalPermissionDto> GetAllProposalPermissions()
        {
            ...
            using (IES.Core.StopwatchTimer sw = new IES.Core.StopwatchTimer("ProposalPermissionLoader.GetAllProposalPermissions", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
        ...
        public ICollection<int> GetIdsByProposalId(int inProposalID)
        {
            ...
            using (IES.Core.StopwatchTimer sw = new IES.Core.StopwatchTimer("ProposalPermissionLoader.GetIdsByProposalId", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
        ...
        public ICollection<int> GetIdsForHomeProposalGrid(ICollection<int> inProposalIDs)
        {
            ...
            using (IES.Core.StopwatchTimer sw = new IES.Core.StopwatchTimer("ProposalPermissionLoader.GetIdsByProposalIds", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
                    toReturn = (from cur in dbModel.ProposalUserRoles
        ...
        {
            using (IES.Core.StopwatchTimer sw = new IES.Core.StopwatchTimer("ProposalPermissionLoader.DeleteIdsByProposalId", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
        ...
        public ICollection<int> GetIdsByUserId(int userId)
        {
            ...
            using (IES.Core.StopwatchTimer sw = new IES.Core.StopwatchTimer("ProposalPermissionLoader.GetIdsByUserId", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
                    toReturn = (from cur in dbModel.ProposalUserRoles
