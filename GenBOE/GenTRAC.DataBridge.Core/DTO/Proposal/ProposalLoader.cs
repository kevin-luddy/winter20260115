				...
				using (genTRACEntities dbModel = new())
				{
					...
					toReturn = dbModel.Proposals.Include("ContractTypeLUs").Include("CostElementLUs").Include("ProposalClassLU")
						...
						.Select(entity => new
						{
							...
							entity.ProposalTitle,
							entity.OTISOpportunityID,
							...
							entity.WorkflowStatusLastUpdated,
							...
							IsRomNte = entity.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_ROM || entity.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_NTE,
							entity.ForecastEmailSent,
							...
							entity.AgreementDate,
							entity.CertificationDate,
							entity.CutOffDateUtilization,
							entity.CertificationTimelineCompleted,
							entity.CertificationLastEmailed,
							entity.NoBidDate,
							entity.RevisionOfId,
							entity.ReasonCertificationNotRequired,
							entity.OtherReasonComment,
							ProposalSetupComments = entity.SetupComments,
							entity.InformationComments,
							entity.ModExecutedLastEmailed,
							entity.ProposalCompletedDate,
				...
				using (genTRACEntities dbModel = new())
				{
					...
					toReturn = (from p in dbModel.Proposals
								...
								select new ProposalDto
								{
									...
									IsRomNte = p.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_ROM || p.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_NTE,
				...
				using (genTRACEntities dbModel = new())
				{
					toReturn = dbModel.Proposals
						.Select(x => new ProposalDto
						{
							...
							IsRomNte = x.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_ROM || x.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_NTE,
		...
		public ICollection<ProposalDto> GetModExecutedDateMissingNotifications()
		{
			...
			using (genTRACEntities context = new())
			{
				...
				toReturn = data.Select(x => new ProposalDto
				{
					...
					IsRomNte = x.Proposals.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_ROM || x.Proposals.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_NTE,
					...
					CutOffDateUtilization = x.Proposals.CutOffDateUtilization == null ? null : (CutOffDateUtilization)x.Proposals.CutOffDateUtilization,
					...
					ReasonCertificationNotRequired = x.Proposals.ReasonCertificationNotRequired == null ? null : (ReasonCertificationNotRequired)x.Proposals.ReasonCertificationNotRequired,
			...
			using (StopwatchTimer sw = new("ProposalLoader.GetProposalsCertificationTimelinePastDue", Log))
			{
				using (genTRACEntities dbModel = new())
				{
					...
					toReturn = proposalsList.Select(entity => new
					{
						...
						entity.Proposals.ProposalTitle,
						entity.Proposals.OTISOpportunityID,
						ProposalStatus = (ProposalStatus)entity.Proposals.ProposalStatusID,
						entity.Proposals.UpdateDate,
						ProposalType = entity.Proposals.ProposalTypeID,
						entity.Proposals.ProgramName,
						entity.Proposals.Customer,
						...
						entity.Proposals.RevisedSubmittalDate,
						entity.Proposals.EstimatedProposalValue,
						CustomerType = (CustomerType)entity.Proposals.CustomerTypeID,
						entity.Proposals.DateAssigned,
						entity.Proposals.DateCreated,
						entity.Proposals.RFPIssuedDate,
						entity.Proposals.RFPReceivedDate,
						entity.Proposals.Comments,
						...
						entity.Proposals.IsScheduleProposal,
						...
						entity.Proposals.WorkflowStatusLastUpdated,
						...
						IsRomNte = entity.Proposals.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_ROM || entity.Proposals.ProposalClassLU.ProposalClass == CommonConstants.PROPOSAL_CLASS_NTE,
						entity.Proposals.ForecastEmailSent,
						...
						entity.Proposals.AgreementDate,
						entity.Proposals.CertificationDate,
						entity.Proposals.CutOffDateUtilization,
						entity.Proposals.CertificationTimelineCompleted,
						entity.Proposals.CertificationLastEmailed,
						entity.Proposals.NoBidDate,
						entity.Proposals.RevisionOfId,
						...
						entity.Proposals.InformationComments,
						entity.Proposals.ModExecutedLastEmailed,
				...
				using (genTRACEntities dbModel = new())
				{
					...
					toReturn = dbModel.Proposals.Where(x => proposalIds.Contains(x.ProposalID) && x.ProposalStatusID != (int)ProposalStatus.Deleted)
						...
						.Select(x => new RevisionHistoryModelView()
						{
							...
							DisplayCertificationTab = DisplayCertificationTab(x.ProposalStatus, x.CCPDRequired),
							DisplayRevisionTab = DisplayRevisionTab(x.IsRevision, x.ProposalStatus)
						}).ToList();
				}
			}
			...
			using (StopwatchTimer sw = new("ProposalLoader.GetAcvProposalData", Log))
			{
				using (genTRACEntities dbModel = new())
				{
					result = dbModel.Proposals.Where(x =>
						...
						.Select(entity => new { TrackingNumber = entity.ProposalTrackingID, entity.ProposalTitle, ProposalId = entity.ProposalID }).Take(100).ToList()
						.Select(entity => (PtmTrackingNumber: entity.TrackingNumber, entity.ProposalTitle, entity.ProposalId)).ToList();
				}
			}
