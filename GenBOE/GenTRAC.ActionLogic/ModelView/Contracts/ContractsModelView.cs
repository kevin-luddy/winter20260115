...
namespace GenTRAC.ActionLogic.ModelView
{
	...
	public class ContractsModelView
	{
		...
		/// </summary>
		[Display(Name = "Planned Program EPP Date")]
		...
		/// </summary>
		[Display(Name = "Planned Mission Segment EPP Date")]
		...
		/// </summary>
		[Display(Name = "Planned Line of Business EPP Date")]
		...
		/// </summary>
		[Display(Name = "Planned Pre-Space EPP Date")]
		...
		/// </summary>
		[Display(Name = "Planned Space EPP Date")]
		...
		/// </summary>
		[Display(Name = "Planned Pre-Corporate EPP Date")]
