...
namespace GenTRAC.ActionLogic
{
	...
	public class ContractsControllerLogic : GenTRACControllerLogic
	{
		...
		public ContractsDto ConvertContractsModelToDto(ContractsModelView model)
		{
			...
			dto.PlannedBidEppDate = model.BidEppDate;
			dto.PlannedProgramEppDate = model.ProgramEppDate;
			dto.PlannedMissionSegmentEppDate = model.MissionSegmentEppDate;
			dto.PlannedLobEppDate = model.LobEppDate;
			dto.PlannedPreSpaceEppDate = model.PreSpaceEppDate;
			dto.PlannedSpaceEppDate = model.SpaceEppDate;
			dto.PlannedPreCorporateEppDate = model.PreCorporateEppDate;
			dto.PlannedCorporateEppDate = model.CorporateEppDate;
		...
		private ContractsModelView ConvertContractsDtoToModel(ContractsDto dto)
		{
			...
			model.BidEppDate = dto.PlannedBidEppDate;
			model.ProgramEppDate = dto.PlannedProgramEppDate;
			model.MissionSegmentEppDate = dto.PlannedMissionSegmentEppDate;
			model.LobEppDate = dto.PlannedLobEppDate;
			model.PreSpaceEppDate = dto.PlannedPreSpaceEppDate;
			model.SpaceEppDate = dto.PlannedSpaceEppDate;
			model.PreCorporateEppDate = dto.PlannedPreCorporateEppDate;
			model.CorporateEppDate = dto.PlannedCorporateEppDate;
