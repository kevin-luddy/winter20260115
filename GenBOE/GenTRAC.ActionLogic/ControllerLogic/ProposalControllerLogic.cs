    ...
    public class ProposalControllerLogic : GenTRACControllerLogic
    {
            ...
            ProposalApprovalsModelView proposalApprovalsInfo, ProposalUserInformationModelView proposalUserInfo, bool isNewRevision)
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("ProposalControllerLogic.SaveNewProposal", this.log))
            {
                ...
                {
                    Id = isNewRevision ? -1 : proposalInfo.ProposalID,
        ...
        public void ValidateGeneralInfoTypes(ProposalGeneralInformationModelView proposalGeneralInfo, ICollection<ValidationMessage> inValidationErrors, bool isForecasted)
        {
            ...
            if (!isForecasted)
            {
                ...
                {
                    if (proposalGeneralInfo.PricingToolName == null || !regexFreeText.IsMatch(proposalGeneralInfo.PricingToolName))
                    {
                ...
                {
                    if (proposalGeneralInfo.BOEToolName == null || !regexFreeText.IsMatch(proposalGeneralInfo.BOEToolName))
                    {
