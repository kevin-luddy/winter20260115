    ...
    public class WorkspaceExportFormatDTO : UpdateableDTO
    {
        ...
        public string PhysicalFilePathCache
        {
            get
            {
                ...
                string physicalFileLocation = (this.templateFilePath == null) ? HttpContext.Current.Server.MapPath("~/Templates/Export/Temp/" + this.ExportFormatName +
                    ((this.ExportFormat.TemplateType == ExcelReportTemplateType.MASTER ||
                      this.ExportFormat.TemplateType == ExcelReportTemplateType.LMSI_STANDARD_LANDSCAPE)
                ...
                {
                    // not found, create it
                    File.WriteAllBytes(physicalFileLocation, this.FileData);
                }
