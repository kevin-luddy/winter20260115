...
namespace GenBOE.DataBridge.DTO
{
    ...
    public class MSTTravelDTODataLoader : ITravelDTODataLoader
    {
        ...
        private Logger _log = new Logger(typeof(MSTTravelDTODataLoader));
        ...
        public MSTTravelDTODataLoader(ITravelTripTaskElementCustomFieldValueXREFLoader travelTripTaskElementCustomFieldLoader, ITravelTripCustomFieldValueXREFLoader travelTripCustomFieldLoader)
        {
