...
namespace GenBOE.DataBridge.DTO
{
    ...
    public class RMSZoneTravelRatesFeesDataLoader
    {
        ...
        {
            this.systemEscalationRatesLoader = escalationLoader;
            this.systemFeesLoader = feesAndCostsLoader;
        }
        ...
        public bool AreCurrentFeesOutOfDate(int workspaceId)
        {
            ...
            ICollection<WorkspaceRMSTravelNonzoneFeesAndCostsDTO> fees = this.getAllFeesAndCostsByWorkspace(workspaceId);
        ...
        {
            bool outOfDate = false;
            ICollection<WorkspaceRMSEscalationRatesDTO> rates = this.getAllEscalationRatesByWorkspace(workspaceId);
