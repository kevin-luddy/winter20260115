...
namespace GenBOE.DataBridge.DTO
{
    ...
    public class BoePickListMapper : PickListMapper
    {
        ...
        /// Default ctor
        /// </summary>
        public BoePickListMapper(LineOfBusinessDataLoader lineOfBusinessLoader, ProposalClassLoader proposalClassLuLoader, ContractTypeLoader contractTypeLuLoader)
        {
        ...
        protected override IPickListLoader GetPickListSettings(PickListEnum pickListType)
        {
            ...
            switch (pickListType)
            {
                case PickListEnum.LineOfBusiness:
                    loader = this.lineOfBusinessLoader;
                    break;
