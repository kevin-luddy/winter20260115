    ...
    public class MoqTypeTableDataLabels
    {
        ...
        public MoqTypeTableDataLabels()
        {
            ...
            if (SystemConfiguration.Instance().CompanyMode == CompanyConfiguration.SpaceSystems)
            {
                ...
                this.TotalRelevantHours = "Total Relevant Hours exclude unpaid (zero cost) hours and service centers, after application of Employee ID Filters";
            }
            else
            {
                this.AdditionalQueryFilters = "Additional Query Filters";
                this.TotalRelevantHours = "New Total Relevant Hours After Additional Query Filters Applied";
            }
        }
