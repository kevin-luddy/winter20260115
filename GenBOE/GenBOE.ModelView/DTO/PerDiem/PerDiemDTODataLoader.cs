...
namespace GenBOE.DataBridge.DTO
{
    ...
    /// </summary>
    public class PerDiemDTODataLoader : GenBOE.DataBridge.DTO.IPerDiemDTODataLoader
    {
        private Logger _log = new Logger(typeof(PerDiemDTODataLoader));

        public PerDiemDTODataLoader() { }
