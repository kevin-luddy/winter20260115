...
namespace IES.Common
{
    ...
    public static class GenImageUtilities
    {
        ...
        /// </summary>
        /// <param name="format">Posted image</param>
        /// <returns>Base64-encoded image</returns>
        public static string ConvertImageToBase64String(System.Web.HttpPostedFileBase image)
        {
            if (image == null)
            {
        ...
        /// <param name="format">Posted image</param>
        /// <returns>Base64-encoded image</returns>
        public static string ConvertImageToBase64SrcString(System.Web.HttpPostedFileBase image)
        {
            if (image == null)
            {
                throw new ArgumentNullException(nameof(image));
            ...
            string srcString = String.Format("data:{0};base64,{1}", image.ContentType, base64String);
        ...
        public static byte[] DownloadImage(Uri uri, string proxy)
        {
            ...
            {
                webClient.Proxy = new System.Net.WebProxy(proxy);
