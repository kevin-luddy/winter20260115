    ...
    public static class Emails
    {
        ...
        public static readonly EmailContent PUBLISH_EMAIL = new EmailContent
        {
            ...
            Body = "The PPR&D has been revised and is available in RDM.<br/><br/>" +
                    ...
                    "For Contract POCs, the PPR&D Disclosure Log can be used to create the necessary disclosures for CCoPD covered proposals.  The log will be updated to include the specifics of this revision shortly.<br/>" + 
                    "{0}<br/>" +
