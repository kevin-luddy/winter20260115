...
namespace GenTRAC.Models
{
    ...
    public partial class genTRACEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> upsertProposalChecklist(Nullable<int> proposalChecklistID, Nullable<System.DateTime> updateDate, Nullable<int> proposalID, Nullable<System.DateTime> proposalSubmittalDate, Nullable<long> iSGSTotalPrice, Nullable<long> profit, Nullable<long> com, Nullable<long> profitFeeWithCom, Nullable<decimal> rOSPercentage, Nullable<decimal> lMLaborHours, Nullable<long> lMLaborCost, Nullable<long> subcontractorCost, Nullable<long> materialCost, Nullable<long> iWTACost, Nullable<long> travelCost, Nullable<long> otherDirectCost, Nullable<bool> deliverChecklistDFARS, Nullable<long> absoluteValue, Nullable<long> costThroughCom)
        {
