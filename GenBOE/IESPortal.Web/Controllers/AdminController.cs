...
namespace IESPortal.Web.Controllers
{
    ...
    public class AdminController : IESController
    {
        ...
        /// The logger
        /// </summary>
        private Logger logger = new Logger(typeof(AdminController));
        ...
        public AdminController(ISecurityInformation securityInformation, BannerMediator bannerMediator, IESPortalAdminControllerLogic adminControllerLogic)
        {
