...
namespace IES.Standard
{
	...
	public enum ProposalLocation
	{
		...
		/// Chantilly, VA
		/// </summary>
		[Description("Chantilly, VA"), IES.Standard.IsActive(false)]
		ChantillyVA = 1,

		/// <summary>
		/// Colorado Springs, CO
		/// </summary>
		[Description("Colorado Springs, CO"), IES.Standard.IsActive(false)]
		ColoradoSpringsCO = 2,

		/// <summary>
		/// Hanover, MD
		/// </summary>
		[Description("Hanover, MD"), IES.Standard.IsActive(false)]
		HanoverMD = 3,

		/// <summary>
		/// Herndon, VA
		/// </summary>
		[Description("Herndon, VA"), IES.Standard.IsActive(false)]
		HerndonVA = 4,

		/// <summary>
		/// Littleton, CO
		/// </summary>
		[Description("Littleton, CO"), IES.Standard.IsActive(false)]
		LittletonCO = 5,

		/// <summary>
		/// Rockville, MD
		/// </summary>
		[Description("Rockville, MD"), IES.Standard.IsActive(false)]
		RockvilleMD = 6,
		...
		/// Virtual
		/// </summary>
		[Description("Virtual"), IES.Standard.IsActive(false)]
		Virtual = 8,
