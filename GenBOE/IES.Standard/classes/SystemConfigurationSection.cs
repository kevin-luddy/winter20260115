                            ...
                            else if (companySettingNode.Name == "connectionStrings")
                            {
                                foreach (XmlNode connectionStringNode in companySettingNode.ChildNodes)
                                {
                                    if (connectionStringNode.NodeType == XmlNodeType.Element && connectionStringNode.Name == "add")
                                    {
                                        ...
                                        connectionString.Name = this.GetAttributeValue(connectionStringNode, "name");
                                        connectionString.ConnectionString = this.GetAttributeValue(connectionStringNode, "connectionString");
                                        connectionString.ProviderName = this.GetAttributeValue(connectionStringNode, "providerName");
