...
namespace IES.Tests.Core
{
    ...
    public class BulkIORateDetailTest
    {
        ...
        public void TestLoader_Save_EX5()
        {
            ...
            ProPricerRateCodeXrefModelView pprcxmv = new()
            {
                Id = -1,
                RateCodeId = -1,
        ...
        {
            RateDetailLoader sut = this.CreateSut();
            Collection<RateDetailModelView> newRateDetails = new();
            ...
            using (TransactionScope scope = new(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = IsolationLevel.Snapshot, Timeout = new TimeSpan(0, 0, 2 * ConfigurationUtilities.GetAppSetting<int>("TransactionTimeout", CommonConstants.DB_TRANSACTION_SCOPE_TIMEOUT_SECONDS_DEFAULT)) }))
            {
