...
namespace RDM.Tests.IO
{
    ...
    public class RdmProPricerExporterTest
    {
        ...
        private RdmProPricerExporter CreateSut()
        {
            ...
            BurdenElementModelView burdenElement1 = new()
			{
                Id = 11,
            ...
            BurdenElementModelView burdenElement2 = new()
			{
                Id = 22,
            ...
            BurdenElementModelView burdenElement3 = new()
			{
                Id = 33,
            ...
            BurdenElementModelView burdenElement4 = new()
			{
                Id = 44,
            ...
            RateDetailModelView rate1 = new()
            {
                ...
                Section = 111,
                ProPricerMappings = new Collection<ProPricerRateCodeXrefModelView>() { new() { Description = "Civil Space Planetary Explor Sys - Lbr", RateCodeExtensionId = null } },
                ...
                Values = new Collection<RateYearModelView>() { new() { Year = 2012, Value = rate }, new() { Year = 2013, Value = rate + 0.01m }, new() { Year = 2014, Value = rate + 0.02m } },
            ...
            RateDetailModelView rate2 = new()
            {
                ...
                Section = 222,
                ProPricerMappings = new Collection<ProPricerRateCodeXrefModelView>() { new() { Description = "ATLO Denver Development Hourly & NES Straight Time Rate", RateCodeExtensionId = 1 }, new() { Description = "ENG Denver Development Hourly & NES Straight Time Rate", RateCodeExtensionId = 2 } },
            ...
            RateDetailModelView rate3 = new()
            {
                ...
                Values = new Collection<RateYearModelView>() { new() { Year = 2012, Value = rate }, new() { Year = 2013, Value = rate + 0.01m }, new() { Year = 2015, Value = rate + 0.02m } },
                Updateable = UpdateType.Upsert
            };
            ...
            RateDetailModelView rate4 = new()
            {
                ...
                GovernmentBurdenPool = burdenPool2.BurdenPool,
                GovernmentBurdenPoolId = burdenPool2.Id,
                ProPricerMappings = new Collection<ProPricerRateCodeXrefModelView>() { new() { Description = "LABS Support Production HR & SNES OT", RateCodeExtensionId = 3 }, new() { Description = "OTHER Support Production HR & SNES OT", RateCodeExtensionId = 4 } },
                Values = new Collection<RateYearModelView>() { new() { Year = 2012, Value = rate }, new() { Year = 2013, Value = rate + 0.01m }, new() { Year = 2014, Value = 0.0m } },
                Updateable = UpdateType.Upsert
            };
            ...
            RdmProPricerExporter sut = new (rates, zipFilePath, burdenPools, burdenElements);
            sut.FindMinMaxYears();            
            return sut;
        }
