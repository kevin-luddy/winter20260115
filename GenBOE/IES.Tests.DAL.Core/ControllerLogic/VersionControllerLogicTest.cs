...
namespace RDM.Tests.ControllerLogic
{
    ...
    public class VersionControllerLogicTest
    {
        ...
        /// Test User Data
        /// </summary>
        private UserData userData = new () { DisplayName = "Test User", Ntid = "moqdomain" };
        ...
        /// </summary>
        private Mock<ISecurityInformation> securityInformation = new();
        ...
        /// </summary>
        private RevisionModelView rev121 = new()
        {
            Id = 1,
            Revision = "121",
        ...
        /// </summary>
        private RevisionModelView rev122 = new()
        {
            Id = 2,
            Revision = "122",
        ...
        /// </summary>
        private RevisionModelView rev123 = new()
        {
            Id = 3,
            Revision = "123",
        ...
        public VersionControllerLogic CreateSut()
        {
            ...
            this.revisionMediator.Setup(x => x.GetAll()).Returns(new List<RevisionModelView> { new() });
            this.revisionMediator.Setup(x => x.GetWipRevision()).Returns(rev123);

            return new VersionControllerLogic(this.rateDetailLoader.Object, this.areaLockingLoader.Object, this.revisionMediator.Object, this.adUtils.Object, this.securityInformation.Object, null, null);
        }
        ...
        private Collection<RateDetailModelView> CreateValidRates()
        {
            ...
            Collection<RateDetailModelView> rates = new();

            RateDetailModelView backwardLookingLowerBound = new()
            {
                RateCode = "backwardLookingLowerBound",
                RateCategory = RateCategory.Fccom,
                Values = new Collection<RateYearModelView>()
                {
                    new() { Year = publishYear - CommonConstants.RATE_TABLE_YEARS_TO_DISPLAY_BACKWARD_LOOKING_ADJUSTMENT, Value = 1 }
                }
            };

            RateDetailModelView backwardLookingUpperBound = new()
            {
                RateCode = "backwardLookingUpperBound",
                RateCategory = RateCategory.Fccom,
                Values = new Collection<RateYearModelView>()
                {
                    new() { Year = publishYear + CommonConstants.RATE_TABLE_YEARS_TO_DISPLAY, Value = (decimal?) 0.1 }
                }
            };

            RateDetailModelView forwardLookingLowerBound = new()
            {
                RateCode = "forwardLookingLowerBound",
                RateCategory = RateCategory.DirectLabor,
                Values = new Collection<RateYearModelView>()
                {
                    new() { Year = publishYear, Value = 1 }
                }
            };

            RateDetailModelView forwardLookingUpperBound = new()
            {
