...
namespace RDM.Tests.ControllerLogic
{
    ...
    public class AdminControllerLogicTest
    {
        ...
        /// </summary>
        private Mock<IRateCodeReplicationLoader> rateCodeReplicationLoader = new();
        ...
        public AdminControllerLogic CreateSut()
        {
            ...
            return new AdminControllerLogic(this.areaLockingLoader.Object, this.revisionMediator.Object, this.adUtils.Object, this.securityInfo.Object, this.rateDetailLoader.Object, this.rateCodeReplicationLoader.Object, null);
        }
        ...
        {
			AdminControllerLogic sut = this.CreateSut();
            this.rateDetailLoader.Setup(x => x.GetRateCodesForRevision(It.IsAny<int>())).Returns(new RateDto[] { new() { Rate = "TIM" }, new() { Rate = "BOB" }, new() { Rate = "JEFF" } });

            this.rateCodeReplicationLoader.Setup(x => x.GetAll()).Returns(new List<RateCodeModelView> { new() { Id = 5, From = "TIM", To = "BOB" } });

            List<RateCodeModelView> rateCodes = new()
			{
        ...
        {
            AdminControllerLogic sut = this.CreateSut();
            Collection<CobraDetailModelView> cobraDetails = new();
        ...
        {
            AdminControllerLogic sut = this.CreateSut();
            Collection<CobraYearGridModelView> cobraYears = new();
        ...
        public void ValidateCobraYearConfigurations_Invalid()
        {
            ...
            DateTime date3a = new(2003, 12, 31);
            DateTime date3b = new(2003, 1, 1);
            int dupYear3 = 2003;
            cobraYears.Add(new CobraYearGridModelView
            {
                CobraDate = date3a,
            ...
            DateTime dupDate4 = new(2003, 12, 31);
            int year3 = 2003;
            int year4 = 2004;
            cobraYears.Add(new CobraYearGridModelView
            {
            ...
            DateTime date5a = new(2003, 12, 31);
            DateTime date5b = new(2006, 1, 1);
            int year5 = 2005;
            cobraYears.Add(new CobraYearGridModelView
            {
                CobraDate = date5a,
            ...
            string expectedMessage2 = string.Format(AdminValidationConstants.COBRA_YEAR_CONFIGURATION_MISSING_YEAR, date2.ToString(CommonConstants.DATE_FORMATTING_MONTH_DAY_YEAR));
            ...
            string expectedMessage4 = string.Format(AdminValidationConstants.COBRA_YEAR_CONFIGURATION_DUPLICATE_COBRA_DATES, dupDate4.ToString(CommonConstants.DATE_FORMATTING_MONTH_DAY_YEAR));
