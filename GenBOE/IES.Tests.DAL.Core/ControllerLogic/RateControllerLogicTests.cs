...
namespace RDM.Tests.ControllerLogic
{
    ...
    public class RateControllerLogicTest
    {
        ...
        /// </summary>
        private Mock<IRateDetailLoader> rateDetailLoader = new();

        /// <summary>
        /// Mock Common Data Mapper
        /// </summary>
        private Mock<ICommonDataMapper> commonDataMapper = new();

        /// <summary>
        /// Mock Home Controller Logic
        /// </summary>
        private Mock<IHomeControllerLogic> homeControllerLogic = new();

        /// <summary>
        /// Mock Burden Pool Loader
        /// </summary>
        private Mock<IBurdenPoolLoader> burdenPoolLoader = new();

        /// <summary>
        /// Mock Section Loader
        /// </summary>
        private Mock<ISectionLoader> sectionLoader = new();
       ...
       /// </summary>
        ...
        /// </summary>
        private Mock<IRateCodeReplicationLoader> replicationLoader = new();
        ...
        /// </summary>
        private Dictionary<string, RateDetailModelView> testRateCodes = new();

		/// <summary>
		/// Set of test 1LMXRateCode MVs for use by tests
		/// </summary>
		private Dictionary<string, RateDetailModelView> oneLMXTestRateCodes = new();
		...
		public RateControllerLogic CreateSut()
        {
            ...
            return new RateControllerLogic(this.rateDetailLoader.Object, this.commonDataMapper.Object,
                ...
                this.replicationLoader.Object, rateFormatter, null);
        }
        ...
        public void Init()
        {
            List<RateCodeModelView> replications = new()
			{
		...
		{
			RateControllerLogic sut = this.CreateSut();
			Collection<RateDetailModelView> validRateDetails = new();
			Collection<RateDetailModelView> invalidRateDetails = new();
			...
			foreach (RateCategory category in Enum.GetValues(typeof(RateCategory)))
			{
				...
				invalidRateDetails.Add(new RateDetailModelView() { Id = id++, RateCode = rateCode, RateCategory = category, Values = new Collection<RateYearModelView>() { new() { Year = 2012, Value = rate, Dirty = true } } });
				...
				validRateDetails.Add(new RateDetailModelView() { Id = id++, RateCode = rateCode, RateCategory = category, Values = new Collection<RateYearModelView>() { new() { Year = 2012, Value = rate, Dirty = true } } });
			}
        ...
        public void TestValidateRateProPricerMappings_Valid()
        {
            ...
            ICollection<RateYearModelView> values = new Collection<RateYearModelView>() { new() { Year = 2012, Value = 1.1m, Dirty = true } };

            RateDetailModelView rateDetails = new()
            {
                RateCategory = RateCategory.DirectLabor,
                RatePrecision = 1,
                Values = values,
        ...
        public void TestValidateRateProPricerMappings_Invalid()
        {
            ...
            ICollection<RateYearModelView> values =
                new Collection<RateYearModelView>() {new() {Year = 2012, Value = 1.1m, Dirty = true}};
        ...
        {
			RateControllerLogic sut = CreateSut();
            Collection<RateDetailModelView> originals = new()
            {
            ...
            Collection<RateDetailModelView> imported = new()
            {
        ...
        public void ValidateImportedRateCodes_RequiredFields()
        {
            RateDetailModelView[] imported = new RateDetailModelView[]
            {
                new() { RateCode= "RateCode1", RateCategoryDescription = "Direct Labor" },
                new() { RateCode= "RateCode2", RateCategoryDescription = "Direct Labor" },
                new() { }
            };
        ...
        public void GetRatesVersionDifferencesTest()
        {
            ...
            RevisionOptionModelView revision1 = new() { Id = 5, Label = "WIP", Revision = "5", StartYear = 2010, EndYear = 2040 };
            RevisionOptionModelView revision2 = new() { Id = 2, Label = "2", Revision = "2", StartYear = 2010, EndYear = 2040 };

            ICollection<RateDetailModelView> expected = new Collection<RateDetailModelView>() { new() { Id = 1, RateCode = "TEST",  } };
