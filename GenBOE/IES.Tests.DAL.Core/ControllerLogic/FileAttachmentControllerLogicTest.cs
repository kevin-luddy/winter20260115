...
namespace RDM.Tests.ControllerLogic
{
    ...
    public class FileAttachmentControllerLogicTest
    {
        ...
        public FileAttachmentControllerLogic CreateSut()
        {
            ...
            return new FileAttachmentControllerLogic(this.areaLockingLoader.Object, this.revisionMediator.Object, this.adUtils.Object, this.securityInfo.Object, null);
        }
        ...
        {
            FileAttachmentControllerLogic sut = this.CreateSut();
            Collection<FileAttachmentRowModelView> fileAttachments = new();
