...
namespace RDM.Tests.ControllerLogic
{
    ...
    public class HomeControllerLogicTest
    {
        ...
        /// </summary>
        private UserData userData2 = new();

        /// <summary>
        /// Area lock data
        /// </summary>
        private AreaLockData areaLockData = new();
        ...
        public void Initialize()
        {
            ...
            this.sut = new HomeControllerLogic(this.areaLockingLoader.Object, this.revisionMediator.Object, this.adUtils.Object, this.securityInfo.Object, ApplicationConfigurationBase.Configuration);

            this.userData = new UserData() { DisplayName = "Test User", Ntid = "test1", Email = "" };
            this.userData2 = new UserData() { DisplayName = "Test User2", Ntid = "test2", Email = "" };
            this.areaLockData = new AreaLockData() { Area = LockArea.None, TimeOfLock = DateTime.Now, LockedBy = this.userData.DeepClone() };
            this.activeUsers2 = new Collection<AreaLockData>() { new() { Area = LockArea.RDMBurdenPools, LockedBy = this.userData, TimeOfLock = DateTime.Now } };
