...
namespace RDM.Web.Controllers
{
    ...
    public class BurdenPoolController : RDMController
    {
        ...
        /// <summary>
        /// Index for Burden Pools
        /// </summary>
        /// <param name="id">Optional Revision Id</param>
        /// <returns>Index page for Burden Pools.</returns>
        public ActionResult Index(int? id)
        {
            return this.View(new BurdenPoolGridModelView { SelectedRevisionId = id });
        }
        ...
        [HttpPost]
        public ActionResult Save([ModelBinder(typeof(JsonNetModelBinder))] Collection<BurdenPoolDetailModelView> collection)
        {
            if (collection == null)
            {
            ...
            Collection<BurdenPoolDetailModelView> filteredCollection = new Collection<BurdenPoolDetailModelView>();
