    ...
    public static class LaborTypeAndSpreadExporter
    {
        ...
        private static void AddDataValidation(WorksheetPart worksheetPart, ICollection<CustomFieldDTO> workspaceCustomFields, int laborResourcesCount, bool isMulti, bool isOffload)
        {
            ...
            ExcelExporter.AddCellReferenceToDataValidationDictionary(dataValidationReferences, ImportExportConstants.RESOURCES,
                (ImportExportConstants.RESOURCETYPE_RESOURCE_CELL_COLUMN_OFFSET), startDataRowIndex, endDataRowIndex);
            ExcelExporter.AddCellReferenceToDataValidationDictionary(dataValidationReferences, ImportExportConstants.PERFORGS,
                (ImportExportConstants.RESOURCETYPE_PERFORG_CELL_COLUMN_OFFSET), startDataRowIndex, endDataRowIndex);

            ExcelExporter.AddCellReferenceToDataValidationDictionary(dataValidationReferences, ImportExportConstants.SPREAD_CURVES,
                (ImportExportConstants.RESOURCETYPE_SPREADCURVE_CELL_COLUMN_OFFSET + spreadOffset), startDataRowIndex, endDataRowIndex);

            if (isOffload)
            {
                int offloadOffset = ImportExportConstants.RESOURCETYPE_SPREADCURVE_CELL_COLUMN_OFFSET + spreadOffset + 4;
