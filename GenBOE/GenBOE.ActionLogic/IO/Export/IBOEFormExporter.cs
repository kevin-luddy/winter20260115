...
namespace GenBOE.ActionLogic.IO.Export
{
	...
	public class IBOEFormExporter : BOEFormExporter<BOEFormIBOEDTO, IBOETableRow>
	{
		...
		public IBOEFormExporter(IUserDTODataLoader userDTODataLoader, IResourceDTODataLoader resourceDTODataLoader, TMCalculator tmCalculator, IRetriever retriever)
