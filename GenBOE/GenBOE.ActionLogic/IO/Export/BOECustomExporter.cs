...
namespace GenBOE.ActionLogic.IO.Export
{
	...
	public class BOECustomExporter : WordExporter, IBOECustomExporter
	{
			...
			if (boeExportModelViews.Any() || boeSummaryGridModelViews.Any())
			{
				...
				foreach (BOEExportModelView boeExportModelView in boeExportModelViews)
				{
					...
					try  // catch and rethrow to give exception some context
					{
						...
						this.ProcessResourceSummaryByElementOfCostTable(boeContainer, boeExportModelView, boeSummaryGridModelView, selectedComponents, exportInputs.FullWorkspace);
		...
		private void ProcessResourceSummaryByElementOfCostTable(SdtElement boeContainer, BOEExportModelView boeExportModelView, ICollection<BOESummaryGridModelView> boeSummaryGridModelView, ICollection<BoeCustomReportComponent> selectedComponents, FullWorkspace ws)
		{
			if (selectedComponents == null)
			{
				throw new ArgumentNullException(nameof(selectedComponents));
			...
			{
				this.PopulateResourceSummaryByElementOfCostTable(resourceSummaryByElementOfCostTableElement, boeExportModelView, boeSummaryGridModelView, ws);
			}
			else
			{
		...
		protected virtual void PopulateResourceSummaryByElementOfCostTable(SdtElement tableContainerElement, BOEExportModelView boeExportModelView, ICollection<BOESummaryGridModelView> data, FullWorkspace ws)
		{
			if (data.Any())
			{
