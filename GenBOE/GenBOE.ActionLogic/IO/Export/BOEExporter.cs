...
namespace GenBOE.ActionLogic.IO.Export
{
    ...
    public class BOEExporter : WordExporter, IBOEExporter
    {
        ...
        {
            AllBOEExportHelper.ExportBOEsToZipFile<bool>(exportInputs, boeExportModelViews, boeSummaryGridModelViews, workSpace, response, returnFilename, templatePath, ExportBOEToWordFileStream, stream, useStream);
        }
								...
								if (taskContainer != null)
                                {
                                    ...
                                    switch (taskElement.ElementType)
                                    {
                                        ...
                                        case BOEExportTaskElementType.Labor:
											...
											this.ProcessSkillMixTable(taskElement, new Collection<BoeCustomReportComponent>(), (SdtElement)taskContainer.TaskContainer, exportInputs, taskElements.FirstOrDefault(x => x.Id == taskElement.BOETaskElementID.Value));
