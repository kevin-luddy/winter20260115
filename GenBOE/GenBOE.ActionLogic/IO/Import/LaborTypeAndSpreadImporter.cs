...
namespace GenBOE.ActionLogic.IO.Import
{
	...
	public class LaborTypeAndSpreadImporter
	{
		...
		/// <summary>
		/// Populate Resource from import file into return variable
		/// </summary>
		/// <param name="importfromfile">Dictionary of Items contained in row</param>
		/// <param name="toReturn">LaborType model populated from Import File Row content</param>
		/// <param name="resourcelist">Resource Options List</param>
	...
	public enum LaborTypeImportResult
	{
		...
		ResourceMissingInvalid = 8, // Obsolete
		PerfOrgMissingInvalid = 9,  // Obsolete
		StartDateMissingInvalid = 10, // Obsolete
		EndDateMissingInvalid = 11, // Obsolete
		SpreadCurveMissing = 12, // Obsolete
		SpreadCurveInvalid = 13, // Obsolete
		NonUniqueResourceTypeID = 14, // Obsolete
		ResourceTypeIDMissingOrInvalid = 15,
		RateTypeSpreadTypeAgreement = 16,
		LaborTypeDateSpreadDateMismatch = 17, // Obsolete
		HoursSpreadInvalid = 18,
		DecimalPrecisionViolation = 19, // Obsolete
		CostSpreadRangeInvalid = 20,
		CostDecimalPrecisionViolation = 21,
		ResourceSpreadsInvalid = 22, // Obsolete
