...
namespace GenBOE.ActionLogic.WorkspaceTransitions
{
    ...
    public class WorkingToInitTransition : DefaultWorkspaceTransition
    {
        Logger _log = new Logger(typeof(WorkingToInitTransition));

        /// <summary>
        /// Constructor for dependency injection
        /// </summary>
        public WorkingToInitTransition(IBoeEmailer inEmailer, IWorkspaceDTODataLoader workspaceLoader) :
        ...
        /// <summary>
        /// Perform validation logic for the state change to occur, there are no restriction to go back to initialize so it returns the base case which is always true.
        /// </summary>
        ...
        protected override void SendEmail1(FullWorkspace workspace)
        {
            ...
            this._Emailer.SendWorkspaceWorkingToInitialization(workspace);
        }
    }
}
