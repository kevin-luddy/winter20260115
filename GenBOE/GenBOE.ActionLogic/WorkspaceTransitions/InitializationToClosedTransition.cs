...
namespace GenBOE.ActionLogic.WorkspaceTransitions
{
    ...
    public class InitializationToClosedTransition : DefaultWorkspaceTransition
    {
        /// <summary>
        /// Constructor for dependency injection
        /// </summary>
        public InitializationToClosedTransition(IBoeEmailer inEmailer, IWorkspaceDTODataLoader workspaceLoader) :
