...
namespace GenBOE.ActionLogic.WorkspaceTransitions
{
    ...
    public class WorkingToLockedTransition : DefaultWorkspaceTransition
    {
        Logger _log = new Logger(typeof(WorkingToLockedTransition));
        /// <summary>
        /// Constructor for dependency injection
        /// </summary>
        public WorkingToLockedTransition(IBoeEmailer inEmailer, IWorkspaceDTODataLoader workspaceLoader) :
        ...
        protected override void SendEmail1(FullWorkspace workspace)
        {
            ...
            this._Emailer.SendWorkspaceWorkingToLocked(workspace);
        }
    }
}
