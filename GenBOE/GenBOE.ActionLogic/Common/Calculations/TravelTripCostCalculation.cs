...
namespace GenBOE.ActionLogic.Common.Calculations
{
    ...
    {
        /// <summary>
        /// Calculate the travel cost for each travel trip, WITHOUT preloaded data
        /// </summary>
        /// <param name="inTravelTrip">Travel Trip</param>
        /// <param name="inWorkspace">Full WS</param>
        /// <returns></returns>
        public virtual TravelTripCostData CalculateTravelCost(TravelTripType inTravelTrip, FullWorkspace inWorkspace)
        {
            ...
            TripDTO trip = inWorkspace.GetTripById(inTravelTrip.SystemTripID);
            decimal miscRate = inWorkspace.GetMiscTravelRateById(trip.MiscTravelRateID).MiscTravelRate;
            PerDiemDTO perDiem = inWorkspace.GetPerDiemById(trip.PerDiemID);

            return this.CalculateTravelCost(inTravelTrip, inWorkspace, trip, miscRate, perDiem, inWorkspace.EscalationRates);
        }
        ...
        public virtual TravelTripCostData CalculateTravelCost(TravelTripType inTravelTrip, FullWorkspace inWorkspace, TripDTO trip, decimal miscRate, PerDiemDTO perDiem, IReadOnlyCollection<EscalationRatesDTO> escalations)
        {
            if (inTravelTrip == null)
            {
                throw new ArgumentNullException(nameof(inTravelTrip));
            ...
            Boolean ActivationDateParse = DateTime.TryParse(sMIECostUpdateActivationDate, out MIECostUpdateActivationDate);
            DateTime MIECostUpdateTripDate;
            Boolean TripDateParse = DateTime.TryParse(sMIECostUpdateTripDate, out MIECostUpdateTripDate);
            ...
            Boolean CanApplyNewFormula = ActivationDateParse && TripDateParse
    ...
    public class TravelTripCostData
    {
        ...
        {
            this.mCostTotal = CostTotal;
            this.mFareTotal = FareTotal;
            this.mHotelTotal = HotelTotal;
            this.mMIETotal = MIETotal;
            this.mRentalCarTotal = RentalCarTotal;
            this.mMiscTotal = MiscTotal;
            this.mEscalationRate = EscalationRate;
            this.mNumOfCars = NumOfCars;
            this.mTotalCostNoEscalation = TotalCostNoEscalation;
            this.mEscalationDollars = EscalationDollars;
        }
        ...
        {
            get { return this.mRentalCarTotal; }
        }
        ...
        {
            get { return this.mEscalationRate; }
        }
        ...
        {
            get { return this.mTotalCostNoEscalation; }
        }
        ...
        {
            get { return this.mEscalationDollars; }
        }
