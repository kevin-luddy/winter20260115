...
namespace GenTRAC.DataBridge.DTO
{
    ...
    public class EmailInformationLoader : IEmailInformationLoader
    {
        ...
        public ICollection<EmailInformationDto> GetAllEmailsToBeSent(int? proposalId)
        {
            ...
            using (IES.Standard.StopwatchTimer sw = new IES.Standard.StopwatchTimer("EmailInformationLoader.GetAllEmailsToBeSent", this.Log))
            {
                // Get the cutoff Date
                DateTime cutoffDate = IES.Standard.Utilities.GetWorkflowCutoffDate();
                ...
                else
                {
                    ...
                    DateTime forecastCutoff = DateTime.Now.AddDays(IES.Standard.ConfigurationUtilities.GetAppSetting<int>("ForecastedDaysOut"));
        ...
        {
            using (IES.Standard.StopwatchTimer sw = new IES.Standard.StopwatchTimer("EmailInformationLoader.UpdateEmailSent", this.Log))
            {
                // get the latest version from DB
                ProposalDto proposal = this.ProposalLoader.GetById(proposalId);
                proposal.Updateable = IES.Standard.UpdateType.Upsert;
        ...
        public ICollection<EmailInformationDto> GetDocumentReminderEmailsToBeSent()
        {
            ...
            using (IES.Standard.StopwatchTimer sw = new IES.Standard.StopwatchTimer("EmailInformationLoader.GetDocumentReminderEmailsToBeSent", this.Log))
            {
