...
namespace GenTRAC.DataBridge.DTO
{
    ...
    /// </summary>
    [Serializable]
    public class ProposalDto : IES.Standard.UpdateableDTO, IES.Standard.Interfaces.ICachableDTO
    {
        /// <summary>
        /// for ICachableDTO..
        /// </summary>
        ...
        public ProposalDto()
        {
            ...
            this.OTISOpportunityID = string.Empty;
            this.ProposalStatus = ProposalStatus.InProgress;
            this.ContractTypeIds = new Collection<int>();
            this.CostElementTypeIds = new Collection<int>();
