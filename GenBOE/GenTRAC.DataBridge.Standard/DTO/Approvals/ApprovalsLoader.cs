...
namespace GenTRAC.DataBridge.DTO
{
    ...
    public class ApprovalsLoader : IApprovalsLoader
    {
        ...
        public ICollection<ApprovalsDto> GetApprovalsForUser(int userId)
        {
            ...
            using (IES.Standard.StopwatchTimer sw = new IES.Standard.StopwatchTimer("ApprovalsLoader.GetApprovalsForUser", this.Log))
            {
        ...
        public int GetPendingApprovalsCountForUser(int userId)
        {
            ...
            using (IES.Standard.StopwatchTimer sw = new IES.Standard.StopwatchTimer("ApprovalsLoader.GetPendingApprovalsCountForUser", this.Log))
            {
                using (genTRACEntities gbe = new genTRACEntities())
                {
