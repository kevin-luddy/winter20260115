...
namespace GenBOE.ActionLogic.ModelView
{
	...
	public class MoqTableData : UpdateableDTO
	{
		...
		public string RepositoryNameSelection
		{
			get
			{
				return this.RepositoryName == IES.Standard.RepositoryName.SapWebi.GetDescription() || string.IsNullOrEmpty(this.RepositoryName)
					? this.RepositoryName
					: IES.Standard.RepositoryName.Other.GetDescription();
			}
		}
