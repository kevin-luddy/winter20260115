...
namespace IES.DataBridge.Loaders
{
	...
	public interface ISectionLoader : IDataLoader<SectionModelView>
    {
		...
		ICollection<SectionModelView> GetAll(RevisionModelView revision, bool sectionsOnly = false, bool includeTextContent = true, ICollection<int> sectionIds = null, string refNumberPrefix = "");
        ...
        ICollection<SectionModelView> RetrieveAllSections(RevisionModelView revision, bool sectionsOnly = false, bool includeTextContent = true);
		...
		/// <summary>
		/// Get a flat collection of SectionModelViews with only Section IDs, Names, and Reference Numbers for the given Revision ID
		/// </summary>
		/// <param name="revisionId">Revision ID</param>
		/// <returns>flat collection of SectionModelViews with only Section IDs, Names, and Reference Numbers</returns>
		ICollection<SectionModelView> GetFlatSectionIdsTitlesAndRefNumbersByRevisionId(int revisionId);
	}
}