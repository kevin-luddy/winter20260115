...
namespace RDSB.Web.Common
{
    ...
    internal static class AuthorizationDictionarySetup
    {
        ...
        {
            Dictionary<string, Dictionary<string, SecurityAuthorization>> result = new Dictionary<string, Dictionary<string, SecurityAuthorization>>();
        ...
        {
            Dictionary<string, SecurityAuthorization> adminControllerActions = new Dictionary<string, SecurityAuthorization>();
