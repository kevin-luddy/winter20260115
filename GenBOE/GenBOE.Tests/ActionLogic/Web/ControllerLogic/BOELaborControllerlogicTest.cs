...
namespace GenBOE.Tests.ActionLogic.Web.ControllerLogic
{
	...
	public class BOELaborControllerlogicTest : MOQObject
	{
		...
		{
			BOELaborControllerLogic sut = CreateSystem();
			RefreshSkillMixModelView result = sut.RefreshSkillMixTables(null, null, null, null);
		...
		public void RefreshSkillMix_HoursOnly_Test()
		{
			...
			RefreshSkillMixModelView result = sut.RefreshSkillMixTables(hours, null, null, null);
		...
		public void RefreshSkillMix_HoursLaborOnly_Test()
		{
			...
			RefreshSkillMixModelView result = sut.RefreshSkillMixTables(hours, laborTypes, null, null);
