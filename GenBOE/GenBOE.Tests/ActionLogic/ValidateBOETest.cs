...
namespace GenBOE.Tests.ActionLogic
{
	...
	public class ValidateBOETest : MOQObject
	{
		...
		/// <summary>
		/// Test Invalid BOE Skill Mix is not thrown when there is a duplicate ResourceNew with 0 BoeSkillMix for RMS
		/// </summary>
		[TestMethod]
		public void ValidateSkillMix_ValidZeroBoeSkillMix_RMS()
		{
			SystemConfiguration.Instance().CompanyMode = CompanyConfiguration.MST;
			List<SkillMixModelView> skillmix = new List<SkillMixModelView>
			{
		...
		/// <summary>
		/// Test Invalid BOE Skill Mix is thrown when there is a duplicate ResourceNew with 0 BoeSkillMix for Space
		/// </summary>
		[TestMethod]
		public void ValidateSkillMix_InvalidZeroBoeSkillMix_Space()
		{
			SystemConfiguration.Instance().CompanyMode = CompanyConfiguration.SpaceSystems;
			List<SkillMixModelView> skillmix = new List<SkillMixModelView>
			{
