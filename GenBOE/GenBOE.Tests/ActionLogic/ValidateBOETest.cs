...
namespace GenBOE.Tests.ActionLogic
{
    ...
    public class ValidateBOETest : MOQObject
    {
        ...
        private Boolean _SpaceEnabled = SystemConfiguration.Instance().CompanyMode == CompanyConfiguration.SpaceSystems;
        ...
        public void BL_ValidateBOE()
        {
            ...
            ValidateBOE sut = new ValidateBOE( _VariableSelectBOEtoSumCalculation.Object, _BOECommentsResponsesValidator.Object, _TripDTODataLoader.Object, _MiscTravelRateDTOLoader.Object, _LocationDTODataLoader.Object, offloadRatesLoader.Object);
        ...
        public void BL_MoreInvalidBOEsToValidate()
        {
            ...
            IValidateBOE sut = new ValidateBOE( _VariableSelectBOEtoSumCalculation.Object,  _BOECommentsResponsesValidator.Object, _TripDTODataLoader.Object, _MiscTravelRateDTOLoader.Object, _LocationDTODataLoader.Object, offloadRatesLoader.Object);
            ...
            sut = new ValidateBOESpaceSystems(_VariableSelectBOEtoSumCalculation.Object,  _BOECommentsResponsesValidator.Object, _TripDTODataLoader.Object, _MiscTravelRateDTOLoader.Object, _LocationDTODataLoader.Object, offloadRatesLoader.Object);
        ...
        public void BL_ValidateLaborTypeBOEDates()
        {
            ...
            // set up workspace
            string WorkspaceName = "ValidateWorkspace";
            WorkspaceDTO workspace = new WorkspaceDTO { Id = 1, WorkspaceName = WorkspaceName, ContractStartDate = Convert.ToDateTime("03/01/2010"), ContractEndDate = Convert.ToDateTime("03/01/2014"), ResourceListID = 1 };
        ...
        public void BL_ValidateTaskCustomFields_Invalid()
        {
            ...
            // set up workspace
            string WorkspaceName = "ValidateWorkspace";
            WorkspaceDTO workspace = new WorkspaceDTO { Id = 1, WorkspaceName = WorkspaceName, ResourceListID = 4 };
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1809:AvoidExcessiveLocals"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1505:AvoidUnmaintainableCode"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1804:RemoveUnusedLocals", MessageId = "_WorkspaceLoader"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1804:RemoveUnusedLocals", MessageId = "validationBOE"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1804:RemoveUnusedLocals", MessageId = "ws"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1804:RemoveUnusedLocals", MessageId = "sut"), TestMethod]
        public void BL_ValidateAllBOEs()
        {
            ...
            retriever.Setup(x => x.GetOdcCollectionByBoeIds(new Collection<int> { boe2.Id }, It.IsAny<bool>())).Returns(new Collection<OtherDirectCostDTO> { new OtherDirectCostDTO { Id = 2, BoeID = boe2.Id, TaskDescription = "mock odc", TaskTitle = "task title", ODCTypes = new Collection<OtherDirectCostType> { new OtherDirectCostType { ODCTypeID = 2, BoeID = boe2.Id, EndDate = Convert.ToDateTime("07/01/2011"), StartDate = Convert.ToDateTime("06/01/2011"), PerformingOrgID = null, ResourceID = null } }, WasDescriptionSet = true, WasMoqTextSet = true } });
            ...
            retriever.Setup(x => x.GetBoeTaskElementCollectionByBoeId(4, It.IsAny<bool>(), It.IsAny<int>(), It.IsAny<int>())).Returns(new Collection<BoeTaskElementDTO> { });
            retriever.Setup(x => x.GetTravelCollectionByBoeID(boe.Id, It.IsAny<bool>())).Returns(new Collection<TravelDTO> { });
            retriever.Setup(x => x.GetOdcCollectionByBoeIds(new Collection<int> { boe.Id, boe2.Id }, It.IsAny<bool>())).Returns(new Collection<OtherDirectCostDTO> { new OtherDirectCostDTO { Id = 1, BoeID = boe.Id, TaskDescription = "mock odc", TaskTitle = "task title", ODCTypes = new Collection<OtherDirectCostType> { new OtherDirectCostType { ODCTypeID = 1, BoeID = boe.Id, EndDate = Convert.ToDateTime("07/01/2011"), StartDate = Convert.ToDateTime("06/01/2011"), PerformingOrgID = null, ResourceID = null } }, WasDescriptionSet = true, WasMoqTextSet = true }, new OtherDirectCostDTO { Id = 2, BoeID = boe2.Id, TaskDescription = "mock odc", TaskTitle = "task title", ODCTypes = new Collection<OtherDirectCostType> { new OtherDirectCostType { ODCTypeID = 2, BoeID = boe2.Id, EndDate = Convert.ToDateTime("07/01/2011"), StartDate = Convert.ToDateTime("06/01/2011"), PerformingOrgID = null, ResourceID = null } }, WasDescriptionSet = true, WasMoqTextSet = true } });
            retriever.Setup(x => x.GetTravelByWorkspaceId(workspace.Id, It.IsAny<bool>())).Returns(new Collection<TravelDTO> { });
