...
namespace IES.Core
{
	...
	public sealed class StartEndDateValidationAttribute : ValidationAttribute
	{
		...
		protected override ValidationResult IsValid(object value, ValidationContext validationContext)
		{
			...
			{
				return new ValidationResult(ErrorMessage, new List<String>() { this.StartDate });
			}
		}
		...
		private bool IsStartEndValid(object value, ValidationContext validationContext)
		{
			...
			if (validationContext.ObjectType.GetProperty(this.StartDate) == null)
			{
			...
			if (validationContext.ObjectType.GetProperty(this.EndDate) == null)
			{
				throw new ArgumentException(
					string.Format(
			...
			object startDateObject = validationContext.ObjectType.GetProperty(this.StartDate).GetValue(value, null);
			object endDateObject = validationContext.ObjectType.GetProperty(this.EndDate).GetValue(value, null);
