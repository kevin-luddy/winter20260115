...
//						{
//							contextFeature.Error = contextFeature.Error.InnerException;
//							View = "SecurityError";
//						}
//						else if (contextFeature.Error != null &&
//							contextFeature.Error.InnerException != null &&
...
//						{
//							contextFeature.Error = contextFeature.Error.InnerException.InnerException;
//							View = "SecurityError";
//						}
//						else if (contextFeature.Error != null &&
//							contextFeature.Error.InnerException != null &&
...
//						{
//							contextFeature.Error = contextFeature.Error.InnerException.InnerException.InnerException;
//							View = "SecurityError";
//						}
//						else if (contextFeature.Error != null &&
