...
namespace IES.Core
{
	...
	public enum ProposalLocation
	{
		...
		/// Chantilly, VA
		/// </summary>
		[Description("Chantilly, VA"), IES.Core.IsActive(false)]
		ChantillyVA = 1,

		/// <summary>
		/// Colorado Springs, CO
		/// </summary>
		[Description("Colorado Springs, CO"), IES.Core.IsActive(false)]
		ColoradoSpringsCO = 2,

		/// <summary>
		/// Hanover, MD
		/// </summary>
		[Description("Hanover, MD"), IES.Core.IsActive(false)]
		HanoverMD = 3,

		/// <summary>
		/// Herndon, VA
		/// </summary>
		[Description("Herndon, VA"), IES.Core.IsActive(false)]
		HerndonVA = 4,

		/// <summary>
		/// Littleton, CO
		/// </summary>
		[Description("Littleton, CO"), IES.Core.IsActive(false)]
		LittletonCO = 5,

		/// <summary>
		/// Rockville, MD
		/// </summary>
		[Description("Rockville, MD"), IES.Core.IsActive(false)]
		RockvilleMD = 6,
		...
		/// Virtual
		/// </summary>
		[Description("Virtual"), IES.Core.IsActive(false)]
		Virtual = 8,
