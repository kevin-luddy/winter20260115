				...
				using (genTRACEntities dbModel = new genTRACEntities())
				{
					...
					toReturn = dbModel.Proposals.Include("ContractTypeLUs").Include("CostElementLUs").Include("ProposalClassLU")
						...
						.Select(entity => new
						{
							...
							IsRomNte = entity.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_ROM || entity.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_NTE,
				...
				using (genTRACEntities dbModel = new genTRACEntities())
				{
					...
					toReturn = (from p in dbModel.Proposals
								...
								select new ProposalDto
								{
									...
									IsRomNte = p.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_ROM || p.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_NTE,
				...
				using (genTRACEntities dbModel = new genTRACEntities())
				{
					toReturn = dbModel.Proposals
						.Select(x => new ProposalDto
						{
							...
							IsRomNte = x.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_ROM || x.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_NTE,
		...
		public ICollection<ProposalDto> GetModExecutedDateMissingNotifications()
		{
			...
			using (genTRACEntities context = new genTRACEntities())
			{
				...
				toReturn = data.Select(x => new ProposalDto
				{
					...
					IsRomNte = x.Proposals.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_ROM || x.Proposals.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_NTE,
			...
			using (StopwatchTimer sw = new StopwatchTimer("ProposalLoader.GetProposalsCertificationTimelinePastDue", Log))
			{
				using (genTRACEntities dbModel = new genTRACEntities())
				{
					...
					toReturn = proposalsList.Select(entity => new
					{
						...
						IsRomNte = entity.Proposals.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_ROM || entity.Proposals.ProposalClassLU.ProposalClass == Constants.PROPOSAL_CLASS_NTE,
