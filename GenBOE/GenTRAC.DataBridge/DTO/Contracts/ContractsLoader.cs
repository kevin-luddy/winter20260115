				...
				if (dtoToUpsert != null)
				{
					...
					using (genTRACEntities dbModel = new genTRACEntities())
					{
						toReturn = dbModel.upsertProposalContractsData(
							...
							dtoToUpsert.ScheduledBidEppDate,
							dtoToUpsert.ScheduledProgramEppDate,
							dtoToUpsert.ScheduledMissionSegmentEppDate,
							dtoToUpsert.ScheduledLobEppDate,
							dtoToUpsert.ScheduledPreSpaceEppDate,
							dtoToUpsert.ScheduledSpaceEppDate,
							dtoToUpsert.ScheduledPreCorporateEppDate,
							dtoToUpsert.ScheduledCorporateEppDate,
				...
				using (genTRACEntities dbModel = new genTRACEntities())
				{
					toReturn = dbModel.ProposalContractsDatas
						.Select(x => new ContractsDto()
						{
							...
							ScheduledBidEppDate = x.ScheduledBidEppDate,
							ScheduledProgramEppDate = x.ScheduledProgramEppDate,
							ScheduledMissionSegmentEppDate = x.ScheduledMissionSegmentEppDate,
							ScheduledLobEppDate = x.ScheduledLobEppDate,
							ScheduledPreSpaceEppDate = x.ScheduledPreSpaceEppDate,
							ScheduledSpaceEppDate = x.ScheduledSpaceEppDate,
							ScheduledPreCorporateEppDate = x.ScheduledPreCorporateEppDate,
							ScheduledCorporateEppDate = x.ScheduledCorporateEppDate,
