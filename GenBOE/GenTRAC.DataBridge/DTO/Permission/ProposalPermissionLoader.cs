...
namespace GenTRAC.DataBridge.DTO
{
    ...
    public class ProposalPermissionLoader : DataLoader<ProposalPermissionDto>, IProposalPermissionLoader
    {
        ...
        {
            this.Log = new IES.Common.Logger(typeof(ProposalPermissionLoader));
        }
        ...
        public override ICollection<ProposalPermissionDto> GetByIds(ICollection<int> ids)
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("ProposalPermissionLoader.GetById", Log))
            {
        ...
        public ICollection<ProposalPermissionDto> GetAllProposalPermissions()
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("ProposalPermissionLoader.GetAllProposalPermissions", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
        ...
        public ICollection<int> GetIdsByProposalId(int inProposalID)
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("ProposalPermissionLoader.GetIdsByProposalId", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
        ...
        public ICollection<int> GetIdsForHomeProposalGrid(ICollection<int> inProposalIDs)
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("ProposalPermissionLoader.GetIdsByProposalIds", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
                    toReturn = (from cur in dbModel.ProposalUserRoles
        ...
        {
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("ProposalPermissionLoader.DeleteIdsByProposalId", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
        ...
        public ICollection<int> GetIdsByUserId(int userId)
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("ProposalPermissionLoader.GetIdsByUserId", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
                    toReturn = (from cur in dbModel.ProposalUserRoles
