...
namespace GenTRAC.DataBridge.DTO
{
    ...
    public class SystemPermissionLoader : DataLoader<SystemPermissionDto>, ISystemPermissionLoader
    {
        ...
        {
            this.Log = new IES.Common.Logger(typeof(SystemPermissionLoader));
        }
        ...
        public override ICollection<SystemPermissionDto> GetByIds(ICollection<int> ids)
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("SystemPermissionLoader.GetById", Log))
            {
        ...
        public ICollection<SystemPermissionDto> GetAllSystemPermissions()
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("SystemPermissionLoader.GetAllSystemPermissions", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
        ...
        public ICollection<int> GetAllIds()
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("SystemPermissionLoader.GetAllIds", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
        ...
        public ICollection<int> GetIdsByUserId(int userId)
        {
            ...
            using (IES.Common.StopwatchTimer sw = new IES.Common.StopwatchTimer("SystemPermissionLoader.GetIdsByUserId", Log))
            {
                using (genTRACEntities dbModel = new genTRACEntities())
                {
                    IEnumerable<int> resultLinq = from cur in dbModel.SystemUserRoles
