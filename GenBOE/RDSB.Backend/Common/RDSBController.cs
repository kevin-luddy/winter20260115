	...
	public abstract class RDSBController : IES.Common.Core.IESController, IActionFilter
	{
		...
		public override void OnActionExecuting(ActionExecutingContext context)
		{
			...
			if (context != null)
			{
				...
				if (ControllerDictionary.TryGetValue(descriptor.ControllerName.ToLower(CultureInfo.CurrentCulture), out Dictionary<string, SecurityAuthorization> actionDictionary))
				{
