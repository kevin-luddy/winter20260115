...
namespace APTSPropricerApi.Controllers
{
    ...
    public class ProposalsController : ProPricerController
    {
        ...
        /// #ctor
        /// </summary>
        public ProposalsController(ILogger<ProposalsController> logger, PoolManagerList poolManagerList) : base(logger)
        {
                ...
                if (res.HasValue)
                {
                    ...
                    if (pr.Locked)
                    {
                        ...
                        return Problem(
                            ...
                            title: "This proposal is locked in PROPRICER.",
                            detail: message,
                    ...
                    {
                        this.Logger.LogError(ex, "Error deleting Proposal");
        ...
        private ICollection<ProposalFolderInfo> GetSpecificUsersProposals(IProPricerConnection ppc, string ntid)
        {
            ...
            {
                this.Logger.LogError(ex, "GetSpecificUsersProposals");
