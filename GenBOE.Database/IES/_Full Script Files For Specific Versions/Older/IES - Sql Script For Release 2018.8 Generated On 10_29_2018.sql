...
/*
    This file was auto-generated for Release: 2018.8, on 10/29/2018.
...
/*
    File: \Release 2018.8\1 - Release 2018.8 Script.sql
*/
PRINT '### Starting file: \Release 2018.8\1 - Release 2018.8 Script.sql';
	...
	ELSE
		BEGIN
			...
			BEGIN TRY
				...
				ON (1=0)
				WHEN NOT MATCHED
					THEN INSERT (UpdateDate, BurdenPool, [Description],  IsGaT2ApplicableForMissionSolutions, RevisionID, IsCommercial, [ExcludeFCCOM])
					VALUES(GETDATE(), BurdenPool, [Description], IsGaT2ApplicableForMissionSolutions, @RevisionID, IsCommercial, [ExcludeFCCOM])
