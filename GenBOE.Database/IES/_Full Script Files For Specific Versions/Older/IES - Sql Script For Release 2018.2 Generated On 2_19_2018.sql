...
/*
    This file was auto-generated for Release: 2018.2, on 2/19/2018.
...
/*
    File: \Release 2018.2\1 - Release 2018.2 Script.sql
*/
PRINT '### Starting file: \Release 2018.2\1 - Release 2018.2 Script.sql';
/*
	## START ##
...
CREATE PROCEDURE [dbo].[deleteRDSBRateCodeXrefviaTableParameter]
(
@RDSBRateCodeXref [dbo].[TT_RDSBRateCodeXref] READONLY
)
AS
/******************************************************************************
**		 
**		Name: [deleteRDSBRateCodeXrefviaTableParameter]
**		Desc: Delete data in RDSBRateCodeXref Table.
**
**		Auth: G. Brunworth
**		Date: 2/2018
*******************************************************************************
...
WHERE ID IN (SELECT ID FROM @RDSBRateCodeXref)
...
CREATE PROCEDURE [dbo].[deleteRDSBSectionXrefviaTableParameter]
(
@RDSBSectionXref [dbo].[TT_RDSBSectionXref] READONLY
)
AS
/******************************************************************************
**		 
**		Name: [deleteRDSBSectionXrefviaTableParameter]
**		Desc: Delete data in RDSBSectionXref Table.
**
**		Auth: G. Brunworth
**		Date: 2/2018
*******************************************************************************
...
WHERE ID IN (SELECT ID FROM @RDSBSectionXref)
