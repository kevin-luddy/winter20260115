IF  EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[deleteProPricerExportResources]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[deleteProPricerExportResources];
...
CREATE PROCEDURE [dbo].[deleteProPricerExportResources]
(
...
/******************************************************************************
**		 
**		Name: [deleteProPricerExportResources]
**		Desc: Delete all of the selected Fields and Custom Fields that 
*				were added to the ProPricer Export - Resources.
**
**		Auth: Don Canuso
**		Date: 4/27/11
*******************************************************************************
