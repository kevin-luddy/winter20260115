...
CREATE TABLE [dbo].[MOQTypeSelectionTableData](
	...
	[DateOfReport] [datetime2](7) NULL,
	[HistoricalProgramName] [varchar](125) NULL,
	[ContractNumber] [varchar](255) NULL,
	[WbsElement] [varchar](2500) NULL,
	[PeriodOfPerformanceStartDate] [datetime2](7) NULL,
	[PeriodOfPerformanceEndDate] [datetime2](7) NULL,
	[TotalWbsHours] [decimal] NULL,
	[AdditionalQueryFilters] [varchar](2500) NULL,
	[TotalRelevantHoursAfterQueryFilters] [decimal] NULL,
	[MiscField1] [varchar](2500) NULL,
	[MiscField2] [varchar](2500) NULL
)
