/* ## START ## 1/25/24 e302876 - PROPH-1484 - New column BRCResourceID */
-- Add new column to dbo table
IF COL_LENGTH('dbo.BOELaborType', 'BRCResourceID') IS NULL
BEGIN
	ALTER TABLE dbo.BOELaborType ADD BRCResourceID [INT] NULL
	-- Add FK for new column
	ALTER TABLE [dbo].[BOELaborType]  WITH CHECK ADD CONSTRAINT [FK_BOELaborType_BRCResource] FOREIGN KEY([BRCResourceID])
	REFERENCES [dbo].[Resource] ([ResourceID])
END
GO
/* 1/25/24 e302876 - PROPH-1484 - New column BRCResourceID ## END ## */

-- Add new column to version table
IF COL_LENGTH('version.BOELaborType', 'BRCResourceID') IS NULL
BEGIN
	ALTER TABLE version.BOELaborType ADD BRCResourceID [INT] NULL
END
GO
-- Drop SPs 1st
