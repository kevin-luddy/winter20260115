...
/*
    This file was auto-generated for Release: 2018.5, on 6/12/2018.
...
/*
    File: \Release 2018.5\1 - Release 2018.5 Script.sql
*/
PRINT '### Starting file: \Release 2018.5\1 - Release 2018.5 Script.sql';
EXEC [dbo].[UpdateDbVersion] @DbVersion = '1', @AppVersion = '2018.5';
GO
/*
       ## START ##
       
       5/7/2018		twilson3		BOEJ-3361 PTM Updates for PickList
*/
       IF NOT EXISTS (
                           ...
                           WHERE
                                  T.name = 'ContractTypeGroupLU' AND
                                  C.name = 'IsActive' AND
                                  S.name = 'dbo'
                           )
BEGIN
       ALTER TABLE [dbo].[ContractTypeGroupLU] ADD IsActive bit not NULL default 1
END

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ContractTypeGroupXREF]') AND type in (N'U'))
BEGIN
	CREATE TABLE [dbo].[ContractTypeGroupXREF] (
		[ContractTypeGroupID] [int] NOT NULL,
		[ContractTypeID] [int] NOT NULL,
	 CONSTRAINT [PK_ContractTypeGroupXREF] PRIMARY KEY CLUSTERED 
	(
		[ContractTypeGroupID] ASC,
		[ContractTypeID] ASC
	...
	ALTER TABLE [dbo].[ContractTypeGroupXREF]  WITH CHECK ADD  CONSTRAINT [FK_ContractTypeGroupXREF_ContractTypeGroup] FOREIGN KEY([ContractTypeGroupID])
	REFERENCES [dbo].[ContractTypeGroupLU] ([ContractTypeGroupID])

	
	ALTER TABLE [dbo].[ContractTypeGroupXREF]  WITH CHECK ADD  CONSTRAINT [FK_ContractTypeGroupXREF_ContractType] FOREIGN KEY([ContractTypeID])
	REFERENCES [dbo].[ContractTypeLU] ([ContractTypeID])

	INSERT INTO [dbo].[ContractTypeGroupXREF] ([ContractTypeGroupID], [ContractTypeID])
	VALUES (1, 1), (1, 3), (1, 22), (1, 2), (1, 23), (1, 24), (1, 20), -- CP Group
		(2, 4), (2, 6), (2, 5), (2, 8), (2, 7), (2, 21), (2, 9), -- FP Group
		(3, 1), (3, 3), (3, 22), (3, 2), (3, 23), (3, 24), (3, 20), (3, 4), (3, 6), (3, 5), (3, 8), (3, 7), -- Hybrid Group
		(3, 21), (3, 9), (3, 11), (3, 12), (3, 14), (3, 13), (3, 10), (3, 18), (3, 19), (3, 17), -- Hybrid Group
		(4, 1), (4, 3), (4, 22), (4, 2), (4, 23), (4, 24), (4, 20), (4, 4), (4, 6), (4, 5), (4, 8), (4, 7), -- IDIQ Group
		(4, 21), (4, 9), (4, 11), (4, 12), (4, 14), (4, 13), (4, 10), (4, 18), (4, 19), (4, 17), -- IDIQ Group
		(5, 12), (5, 14), (5, 13), (5, 10), -- IWTA
		(6, 17), -- Other Group
		(7, 18), (7, 19); -- T&M Group

	ALTER TABLE ProductLine ALTER COLUMN ProductLineName VARCHAR(50) NOT NULL

	ALTER TABLE ProductLine DROP COLUMN ProductLineURL

	ALTER TABLE [dbo].[ProductLine] DROP CONSTRAINT [FK_ProductLine_BusinessArea]

	ALTER TABLE ProductLine DROP COLUMN BusinessAreaID

	ALTER TABLE ProductLine DROP COLUMN ForesightproductLineID

	ALTER TABLE ProductLine DROP COLUMN ProductLineLongName
	...
	INSERT INTO [dbo].[ContractTypeLU] ([ContractType], IsActive)
	VALUES ('Coop.Agreement/Grant', 0), ('Commercial', 0);

	UPDATE [ContractTypeLU] SET [ContractType] = 'CPAF' WHERE [ContractType] = 'Cost Plus Award Fee'
	UPDATE [ContractTypeLU] SET [ContractType] = 'CPIF' WHERE [ContractType] = 'Cost Plus Incentive Fee'
	UPDATE [ContractTypeLU] SET [ContractType] = 'CPFF' WHERE [ContractType] = 'Cost Plus Fixed Fee'
	UPDATE [ContractTypeLU] SET [ContractType] = 'CRC' WHERE [ContractType] = 'Cost Reimbursable'
	UPDATE [ContractTypeLU] SET [ContractType] = 'FFP' WHERE [ContractType] = 'Firm Fixed Price'
	-- TODO TIW
	UPDATE [ContractTypeLU] SET [ContractType] = 'FPAF' WHERE [ContractType] = 'Fixed Price Award Fee'
	UPDATE [ContractTypeLU] SET [ContractType] = 'FPI' WHERE [ContractType] = 'Fixed Price Incentive'
	UPDATE [ContractTypeLU] SET [ContractType] = 'FPIA' WHERE [ContractType] = 'Fixed Price Incentive Award'
	UPDATE [ContractTypeLU] SET [ContractType] = 'FPIF' WHERE [ContractType] = 'Fixed Price Incentive Fee'
	UPDATE [ContractTypeLU] SET [ContractType] = 'FPLOE' WHERE [ContractType] = 'Fixed Price Level of Effort'
	UPDATE [ContractTypeLU] SET [ContractType] = 'IDIQ' WHERE [ContractType] = 'Indefinite Delivery / Indefinite Quantity (IDIQ)'
	UPDATE [ContractTypeLU] SET [ContractType] = 'OTA' WHERE [ContractType] = 'Other Transactions (OTA)'
	UPDATE [ContractTypeLU] SET [ContractType] = 'Labor Hour' WHERE [ContractType] = 'Time and Material Labor Hour'
	UPDATE [ContractTypeLU] SET [ContractType] = 'T&M' WHERE [ContractType] = 'Time and Materials'

END

GO

IF NOT EXISTS (SELECT 1 FROM [dbo].ProductLine WHERE ProductLineName = 'Production Ops (PO)')
BEGIN
	INSERT INTO ProductLine ([ProductLineName], [IsActive]) VALUES 
	('Production Ops (PO)', 0), ('Commercial Ventures (COM)', 0);
END
GO
...
/*
       ...
       5/11/2018		ranzalon		BOEJ-3484 Update Checklist text
										Update to question 36
*/

IF NOT EXISTS (SELECT 1 FROM [dbo].[ProposalPricingReview] WHERE [ChecklistVersion] = 11)
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT [dbo].[ProposalPricingReview] ([ProposalPricingReviewID], [ChecklistVersion], [IsCurrent], [ProposalChecklistTypeID]) VALUES (12, 11, 1, 1)
...
/*
	5/11/2018		ranzalon			BOEJ-3484 PTM Update Checklist text
	## END ##
*/ 

/*
    ## START ##
    5/30/2018		ranzalon		BOEJ-3405 Application Behaviors - Submittal Date
*/
...
IF EXISTS (
			...
			WHERE
					...
					C.name = 'TempProposalSubmittalDate' AND
					S.name = 'dbo'
		  )
	BEGIN
		...
		WHERE [ProposalSubmittalDate] IS NULL
		
		ALTER TABLE [dbo].[ProposalChecklist]
		DROP COLUMN [TempProposalSubmittalDate]
...
/*
    ## START ##
    6/04/2018		brunworg		BOEJ-3480 PTM table names old/wrong. 
									Change ProductLine => LineOfBusinessLU
									Change LineOfBusiness => ProgramAreaLU
									Change vwLineOfBusiness => vwProgramArea
									Change ProductLineRoleXREF => LineOfBusinessRoleXREF
*/

-------------------------------------------------------------------------------------------------------------------
-- Create LineOfBusinessLU
-------------------------------------------------------------------------------------------------------------------
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LineOfBusinessLU]') AND type in (N'U'))
BEGIN
	SET ANSI_NULLS ON
	SET QUOTED_IDENTIFIER ON

	CREATE TABLE [dbo].[LineOfBusinessLU](
		[LineOfBusinessID] [int] IDENTITY(1,1) NOT NULL,
		[LineOfBusinessName] [varchar](50) NOT NULL,
		[IsActive] [bit] NOT NULL,
	 CONSTRAINT [PK_LineOfBusinessLU] PRIMARY KEY CLUSTERED 
	(
		[LineOfBusinessID] ASC
	)WITH (PAD_INDEX = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100) ON [PRIMARY]
	) ON [PRIMARY]

	ALTER TABLE [dbo].[LineOfBusinessLU] ADD  CONSTRAINT [DF_LineOfBusinessLU_IsActive]  DEFAULT ((1)) FOR [IsActive]

	-- Copy data from old ProductLine table into new LineOfBusinessLU table.
    SET IDENTITY_INSERT [dbo].[LineOfBusinessLU] ON
	INSERT INTO [dbo].[LineOfBusinessLU] ([LineOfBusinessID], [LineOfBusinessName], [IsActive])
	SELECT [ProductLineID], [ProductLineName], [IsActive] FROM [dbo].[ProductLine];
	SET IDENTITY_INSERT [dbo].[LineOfBusinessLU] OFF
END
GO

-------------------------------------------------------------------------------------------------------------------
-- Create ProgramAreaLU
-------------------------------------------------------------------------------------------------------------------
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ProgramAreaLU]') AND type in (N'U'))
BEGIN
	SET ANSI_NULLS ON
	SET QUOTED_IDENTIFIER ON

	CREATE TABLE [dbo].[ProgramAreaLU](
		[ProgramAreaID] [int] IDENTITY(1,1) NOT NULL,
		[ProgramAreaName] [varchar](50) NOT NULL,
		[LineOfBusinessID] [int] NOT NULL,
		[IsActive] [bit] NOT NULL,
	 CONSTRAINT [PK_ProgramAreaLU] PRIMARY KEY CLUSTERED 
	(
		[ProgramAreaID] ASC
	)WITH (PAD_INDEX = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 100) ON [PRIMARY]
	) ON [PRIMARY]

	ALTER TABLE [dbo].[ProgramAreaLU] ADD  CONSTRAINT [DF_ProgramAreaLU_IsActive]  DEFAULT ((1)) FOR [IsActive]

	ALTER TABLE [dbo].[ProgramAreaLU]  WITH CHECK ADD  CONSTRAINT [FK_ProgramAreaLU_LineOfBusinessLU] FOREIGN KEY([LineOfBusinessID])
	REFERENCES [dbo].[LineOfBusinessLU] ([LineOfBusinessID])

	ALTER TABLE [dbo].[ProgramAreaLU] CHECK CONSTRAINT [FK_ProgramAreaLU_LineOfBusinessLU]

	-- Copy data from old LineOfBusiness table into new ProgramAreaLU table.
    SET IDENTITY_INSERT [dbo].[ProgramAreaLU] ON
	INSERT INTO [dbo].[ProgramAreaLU] ([ProgramAreaID], [ProgramAreaName], [LineOfBusinessID], [IsActive])
	SELECT [LineOfBusinessID], [LineOfBusinessName], [ProductLineID], [IsActive] FROM [dbo].[LineOfBusiness];
	SET IDENTITY_INSERT [dbo].[ProgramAreaLU] OFF
END
GO

-------------------------------------------------------------------------------------------------------------------
-- Change vwLineOfBusiness => vwProgramArea
-- Note: vwProgramArea will be created by a separate Object Script
-------------------------------------------------------------------------------------------------------------------
IF EXISTS (
            SELECT * FROM sys.all_views V 
                    INNER JOIN sys.schemas S ON V.schema_id =  S.schema_id
            WHERE
                    V.name = 'vwLineOfBusiness' AND
                    S.name = 'dbo'
            )
BEGIN
...
-------------------------------------------------------------------------------------------------------------------
-- Create LineOfBusinessRoleXREF
-------------------------------------------------------------------------------------------------------------------
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LineOfBusinessRoleXref]') AND type in (N'U'))
BEGIN
	SET ANSI_NULLS ON
	SET QUOTED_IDENTIFIER ON

	CREATE TABLE [dbo].[LineOfBusinessRoleXREF](
		[SystemUserRoleID] [int] NOT NULL,
		[LineOfBusinessID] [int] NOT NULL,
	 CONSTRAINT [PK_LineOfBusinessRoleXREF] PRIMARY KEY CLUSTERED 
	(
	...
	ALTER TABLE [dbo].[LineOfBusinessRoleXREF]  WITH CHECK ADD  CONSTRAINT [FK_LineOfBusinessRoleXREF_LineOfBusinessLU] FOREIGN KEY([LineOfBusinessID])
	REFERENCES [dbo].[LineOfBusinessLU] ([LineOfBusinessID])

	ALTER TABLE [dbo].[LineOfBusinessRoleXREF] CHECK CONSTRAINT [FK_LineOfBusinessRoleXREF_LineOfBusinessLU]

	ALTER TABLE [dbo].[LineOfBusinessRoleXREF]  WITH CHECK ADD  CONSTRAINT [FK_LineOfBusinessRoleXREF_SystemUserRole] FOREIGN KEY([SystemUserRoleID])
	REFERENCES [dbo].[SystemUserRole] ([SystemUserRoleID])

	ALTER TABLE [dbo].[LineOfBusinessRoleXREF] CHECK CONSTRAINT [FK_LineOfBusinessRoleXREF_SystemUserRole]

	-- Copy data from old ProductLineRoleXREF table into new LineOfBusinessRoleXREF table.
	INSERT INTO [dbo].[LineOfBusinessRoleXREF] ([SystemUserRoleID], [LineOfBusinessID])
	SELECT [SystemUserRoleID], [ProductLineID] FROM [dbo].[ProductLineRoleXREF];
END
GO

-------------------------------------------------------------------------------------------------------------------
-- Clean up foreign key constraints and columns.
-------------------------------------------------------------------------------------------------------------------
IF EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Proposal_ProductLine]') AND parent_object_id = OBJECT_ID(N'[dbo].[Proposal]'))
BEGIN
	ALTER TABLE [dbo].[Proposal] DROP CONSTRAINT [FK_Proposal_ProductLine]
END

IF EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Proposal_LineOfBusiness]') AND parent_object_id = OBJECT_ID(N'[dbo].[Proposal]'))
BEGIN
	ALTER TABLE [dbo].[Proposal] DROP CONSTRAINT [FK_Proposal_LineOfBusiness]
END

IF EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_LineOfBusiness_ProductLine]') AND parent_object_id = OBJECT_ID(N'[dbo].[LineOfBusiness]'))
BEGIN
	ALTER TABLE [dbo].[LineOfBusiness] DROP CONSTRAINT [FK_LineOfBusiness_ProductLine]
END

IF EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[DF_LineOfBusiness_IsActive]') AND parent_object_id = OBJECT_ID(N'[dbo].[LineOfBusiness]'))
BEGIN
	ALTER TABLE [dbo].[LineOfBusiness] DROP CONSTRAINT [DF_LineOfBusiness_IsActive]
END

IF EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProductLineRoleXREF_ProductLine]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProductLineRoleXREF]'))
BEGIN
	ALTER TABLE [dbo].[ProductLineRoleXREF] DROP CONSTRAINT [FK_ProductLineRoleXREF_ProductLine]
END

IF EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[DF_ProductLine_IsActive]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProductLine]'))
BEGIN
	ALTER TABLE [dbo].[ProductLine] DROP CONSTRAINT [DF_ProductLine_IsActive]
END
GO

-- Add ProgramAreaID column to Proposal table.
IF NOT EXISTS (
                SELECT * FROM sys.all_columns C
                        INNER JOIN sys.tables T on C.object_id = T.object_id
                        INNER JOIN sys.schemas S ON T.schema_id =  S.schema_id
                WHERE
                        T.name = 'Proposal' AND
                        C.name = 'ProgramAreaID' AND
                        S.name = 'dbo'
                )
BEGIN
	ALTER TABLE [dbo].[Proposal] ADD ProgramAreaID int;
END
GO

-- Set ProgramAreaID and LineOfBusinessID values.
-- Note: Existing Proposal.LineOfBusinessID column will reference the new LineOfBusinessLU table.
IF EXISTS (
                SELECT * FROM sys.all_columns C
                        INNER JOIN sys.tables T on C.object_id = T.object_id
                        INNER JOIN sys.schemas S ON T.schema_id =  S.schema_id
...
BEGIN
	UPDATE [dbo].[Proposal]
	SET ProgramAreaID = LineOfBusinessID; -- transfer old LineOfBusinessID to new ProgramAreaID

	UPDATE [dbo].[Proposal]
	SET LineOfBusinessID = ProductLineID; -- transfer ProductLineID to LineOfBusinessID

	ALTER TABLE [dbo].[Proposal] ALTER COLUMN [ProgramAreaID] int NOT NULL;

	ALTER TABLE [dbo].[Proposal] DROP COLUMN [ProductLineID];

	ALTER TABLE [dbo].[Proposal]  WITH CHECK ADD  CONSTRAINT [FK_Proposal_ProgramAreaLU] FOREIGN KEY([ProgramAreaID])
		REFERENCES [dbo].[ProgramAreaLU] ([ProgramAreaID]);

	ALTER TABLE [dbo].[Proposal]  WITH CHECK ADD  CONSTRAINT [FK_Proposal_LineOfBusinessLU] FOREIGN KEY([LineOfBusinessID])
		REFERENCES [dbo].[LineOfBusinessLU] ([LineOfBusinessID]);
END
GO

-- Drop old ProductLine table.
DROP TABLE [dbo].[ProductLine];
GO

-- Drop old LineOfBusiness table.
DROP TABLE [dbo].[LineOfBusiness];
GO

-- Drop old ProductLineRoleXREF table.
DROP TABLE [dbo].[ProductLineRoleXREF];
GO
...
/*
	## START ##
	6/13/2018 Dusan BOEJ-3578: Support changes to the Checklist "Additional Instructions"
*/ 

DECLARE @urlToRemove VARCHAR(200) = 'https://space.p.external.lmco.com/sites/fbo/CCDME/Estimating/Checklist%20Reference%20Documents/';
DECLARE @tokenString VARCHAR(20) = '__BASE_URL__';

UPDATE [dbo].[PARChecklistContent]
	SET ChecklistText = REPLACE(ChecklistText, @urlToRemove, @tokenString);
GO
