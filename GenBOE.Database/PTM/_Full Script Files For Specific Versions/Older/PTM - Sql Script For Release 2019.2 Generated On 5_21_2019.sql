...
/*
    This file was auto-generated for Release: 2019.2, on 5/21/2019.
...
ALTER DATABASE genTrac SET COMPATIBILITY_LEVEL = 120;
GO

/*
    File: \Release 2019.2\Release 2019.2.sql
*/
PRINT '### Starting file: \Release 2019.2\Release 2019.2.sql';
EXEC [dbo].[UpdateDbVersion] @DbVersion = '1', @AppVersion = '2019.3';
GO
...
(
	(
		...
		(
			(
				(@ProposalStatusID = 1/*In Progress*/ OR @ProposalStatusID = 6/*Submitted*/) AND
